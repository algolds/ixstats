...
A language has rules. It has sounds, structures, patterns, histories, exceptions, and cultural meaning. **Onoma gives creators the machinery to build those systems.**
...
# 03 — Linguistic Vocabulary & Parameter Abstraction

A foundational rule of Onoma design:
