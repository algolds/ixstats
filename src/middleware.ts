...
function generateCSP(nonce: string): string {
  ...
  const directives = [
    ...
    `connect-src 'self' https://clerk.ixwiki.com https://accounts.ixwiki.com https://*.clerk.accounts.dev https://ixwiki.com https://commons.wikimedia.org https://api.unsplash.com wss: ws:`,
