...
export const ACHIEVEMENT_TEMPLATES: Partial<DiplomaticAchievement>[] = [
  ...
  // Legendary Achievement
  {
    ...
    hidden: true,
    dependsOn: ['alliance_architect', 'festival_host', 'trade_pioneer', 'intelligence_analyst', 'rising_star']
  }
];
...
export const getUnlockedAchievements = (achievements: DiplomaticAchievement[]): DiplomaticAchievement[] => {
