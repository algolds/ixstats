    ...
    const economyData: EconomyData = {
      ...
      labor: {
        ...
        minimumWage: Math.floor(
          (countryData.currentGdpPerCapita || countryData.baselineGdpPerCapita || 0) / 52 / 40
        ),
        averageAnnualIncome:
          countryData.currentGdpPerCapita || countryData.baselineGdpPerCapita || 0,
        employmentBySector: {
      ...
      fiscal: {
        ...
        governmentRevenueTotal:
          countryData.governmentRevenueTotal ??
          enhancedData.enhancedNominalGDP * (enhancedData.enhancedTaxRevenueGDPPercent / 100),
        taxRevenuePerCapita:
          countryData.taxRevenuePerCapita ??
          (enhancedData.enhancedNominalGDP * (enhancedData.enhancedTaxRevenueGDPPercent / 100)) /
            (enhancedData.enhancedPopulation || 1),
        ...
        taxRates: {
          personalIncomeTaxRates: Array.isArray(
      ...
      income: {
        economicClasses:
          countryData.incomeDistribution && countryData.incomeDistribution.economicClasses
      ...
      spending: createDefaultGovernmentSpendingData({
        ...
        socialSafety: 18,
        totalSpending:
          countryData.totalGovernmentSpending ??
          (countryData.currentTotalGdp || countryData.nominalGDP || 0) * 0.22,
        spendingGDPPercent: countryData.spendingGDPPercent ?? 22,
        spendingPerCapita:
          countryData.spendingPerCapita ??
          ((countryData.currentTotalGdp || countryData.nominalGDP || 0) * 0.22) /
            (countryData.currentPopulation || countryData.baselinePopulation || 1),
        deficitSurplus: countryData.budgetDeficitSurplus ?? 0,
        spendingCategories: (countryData.governmentBudget &&
        countryData.governmentBudget.spendingCategories
          ? typeof countryData.governmentBudget.spendingCategories === "string"
            ? JSON.parse(countryData.governmentBudget.spendingCategories)
            : countryData.governmentBudget.spendingCategories
      ...
      demographics: {
        ...
        regions:
          countryData.demographics && countryData.demographics.regions
            ...
            : [
                {
                  name: "Capital Region",
                  population:
                    (countryData.currentPopulation || countryData.baselinePopulation || 0) * 0.3,
                  urbanPercent: 95,
                  color: "#3b82f6",
                },
                {
                  ...
                  population:
                    (countryData.currentPopulation || countryData.baselinePopulation || 0) * 0.25,
                  urbanPercent: 60,
                  color: "#22c55e",
                },
                {
                ...
                },
                {
                  name: "Other Regions",
                  population:
                    (countryData.currentPopulation || countryData.baselinePopulation || 0) * 0.2,
                  urbanPercent: 45,
                  color: "#8b5cf6",
                },
              ],
        educationLevels:
          countryData.demographics && countryData.demographics.educationLevels
        ...
        citizenshipStatuses:
          countryData.demographics && countryData.demographics.citizenshipStatuses
