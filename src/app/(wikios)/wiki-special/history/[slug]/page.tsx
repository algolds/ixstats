// src/app/(wikios)/wiki-special/history/[slug]/page.tsx
      ...
      <div className="wikios-special-page">
        ...
        {selectedFrom && selectedTo && (
          <div className="wikios-history-compare">
            <Link
              href={withBasePath(`/wiki-special/diff?from=${selectedFrom}&to=${selectedTo}`)}
            ...
            {revisions.map((rev, idx) => {
              ...
              return (
                <li key={rev.revid} className="wikios-history-item">
                  ...
                  {prevRev && (
                    <Link
                      href={withBasePath(`/wiki-special/diff?from=${prevRev.revid}&to=${rev.revid}`)}
                  ...
                  <Link
                    href={withBasePath(`/wiki-special/contributions/${encodeURIComponent(rev.user)}`)}
