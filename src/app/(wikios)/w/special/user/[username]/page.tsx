// src/app/(wikios)/w/special/user/[username]/page.tsx
            ...
            <div className="wikios-profile-grid">
              ...
              <div className="wikios-profile-sidebar">
                ...
                <section className="wikios-profile-section">
                  ...
                  <Link href={withBasePath(`/w/special/contributions/${encodeURIComponent(username)}`)} className="wikios-profile-view-all">
