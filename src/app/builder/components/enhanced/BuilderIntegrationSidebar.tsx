              ...
              <div className="space-y-1">
                <div className="flex items-center justify-between">
                  ...
                  >
                    ...
                    <span className="font-medium">{metrics.gdpGrowthRate.toFixed(1)}%</span>
                  </div>
                </div>
                <div className="flex items-center justify-between">
                  <span>Inflation</span>
                  <div
                    className={`flex items-center gap-0.5 ${
                      metrics.inflationRate <= 2
                        ? "text-green-600 dark:text-green-400"
                        : metrics.inflationRate <= 4
                          ? "text-yellow-600 dark:text-yellow-400"
                          : "text-red-600 dark:text-red-400"
                    }`}
                  >
                    <span className="font-medium">{metrics.inflationRate.toFixed(1)}%</span>
                  </div>
                </div>
                <div className="flex items-center justify-between">
                  ...
                  <div
                    className={`flex items-center gap-0.5 ${
                      metrics.unemploymentRate < 5
                        ? "text-green-600 dark:text-green-400"
                        : metrics.unemploymentRate < 10
                          ? "text-yellow-600 dark:text-yellow-400"
                          : "text-red-600 dark:text-red-400"
                    }`}
                  >
                    <span className="font-medium">{metrics.unemploymentRate.toFixed(1)}%</span>
                  </div>
                </div>
              </div>
            </div>
