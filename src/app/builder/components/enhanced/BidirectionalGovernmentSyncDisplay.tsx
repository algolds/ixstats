                  ...
                  >
                    ...
                    <div className="mb-3 grid grid-cols-2 gap-4 md:grid-cols-4">
                      ...
                      <div className="text-center">
                        ...
                        <div
                          className={`text-sm font-medium ${getImpactColor(recommendation.economicImpact.stabilityImpact)}`}
                        >
                          {recommendation.economicImpact.stabilityImpact > 0 ? "+" : ""}
                          {recommendation.economicImpact.stabilityImpact.toFixed(1)}%
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center justify-between text-xs text-gray-600 dark:text-gray-400">
                      <div className="flex items-center space-x-4">
                        <span>
                          Implementation: {recommendation.implementationCost > 0 ? "+" : ""}₡
                          {Math.abs(recommendation.implementationCost).toLocaleString()}
                        </span>
                        <span>
                          Maintenance: {recommendation.maintenanceCost > 0 ? "+" : ""}₡
                          {Math.abs(recommendation.maintenanceCost).toLocaleString()}/mo
                        </span>
                      </div>
                      <span className="font-medium">
                        {recommendation.currentStatus === "present"
                          ? "Currently Active"
                          : "Not Implemented"}
                      </span>
                    </div>
                  ...
                  >
                    ...
                    <div className="mb-3 grid grid-cols-2 gap-4 md:grid-cols-6">
                      ...
                      <div className="text-center">
                        ...
                        <div
                          className={`text-sm font-medium ${getImpactColor(impact.economicImpact.tradeImpact)}`}
                        >
                          {impact.economicImpact.tradeImpact > 0 ? "+" : ""}
                          {impact.economicImpact.tradeImpact.toFixed(1)}%
                        </div>
                      </div>
                      <div className="text-center">
                        <div className="flex items-center justify-center space-x-1">
                        ...
                        <div
                          className={`text-sm font-medium ${getImpactColor(impact.economicImpact.innovationImpact)}`}
                        >
                          {impact.economicImpact.innovationImpact > 0 ? "+" : ""}
                          {impact.economicImpact.innovationImpact.toFixed(1)}%
                        </div>
                      </div>
                      <div className="text-center">
                        <div className="flex items-center justify-center space-x-1">
                        ...
                        <div
                          className={`text-sm font-medium ${getImpactColor(impact.economicImpact.stabilityImpact)}`}
                        >
                          {impact.economicImpact.stabilityImpact > 0 ? "+" : ""}
                          {impact.economicImpact.stabilityImpact.toFixed(1)}%
                        </div>
                      </div>
                    </div>
