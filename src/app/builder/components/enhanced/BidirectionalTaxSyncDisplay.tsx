              ...
              {taxRecommendations.map((recommendation) => (
                ...
                >
                  <div className="flex items-start justify-between mb-3">
                    ...
                    <div className="flex items-center space-x-2">
                      <Badge variant={getPriorityBadgeVariant(recommendation.implementationPriority)}>
                  ...
                  <div className="flex items-center justify-between text-xs text-gray-600 dark:text-gray-400">
                    ...
                    <span className={`font-medium ${getImpactColor(recommendation.estimatedRevenueChange)}`}>
                      {recommendation.estimatedRevenueChange > 0 ? '+' : ''}{recommendation.estimatedRevenueChange.toFixed(1)}%
                    </span>
                  </div>
                </motion.div>
              ))}
              ...
              {economicImpacts.map((impact, index) => (
                ...
                >
                  <div className="flex items-start justify-between mb-3">
                    ...
                    <div className="flex items-center space-x-2">
                      <Badge variant="outline">
                        {impact.taxChange.effectiveRate}% rate
                      </Badge>
                      <Badge 
                        variant="outline" 
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mb-3">
                    ...
                    <div className="text-center">
                      ...
                      <div className={`text-sm font-medium ${getImpactColor(impact.economicImpact.consumptionImpact)}`}>
                        {impact.economicImpact.consumptionImpact > 0 ? '+' : ''}{impact.economicImpact.consumptionImpact.toFixed(1)}%
                      </div>
                    </div>
                    <div className="text-center">
                      <div className="flex items-center justify-center space-x-1">
                      ...
                      <div className={`text-sm font-medium ${getImpactColor(impact.economicImpact.inflationImpact)}`}>
                        {impact.economicImpact.inflationImpact > 0 ? '+' : ''}{impact.economicImpact.inflationImpact.toFixed(1)}%
                      </div>
                    </div>
                  </div>
