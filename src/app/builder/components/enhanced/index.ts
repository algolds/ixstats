...
export const EconomicArchetypeDisplay = lazy(() =>
  import('./EconomicArchetypeDisplay').then(module => ({ default: module.EconomicArchetypeDisplay }))
);

export const IntegrationTestingDisplay = lazy(() =>
  import('./IntegrationTestingDisplay').then(module => ({ default: module.IntegrationTestingDisplay }))
);
