...
export function LazyComponent({
  ...
  return <div ref={ref}>{hasBeenVisible.current ? children : fallback}</div>;
}
...
export function useBatchedUpdates<T>(
  ...
  const batchedSetValue = React.useCallback(
    (newValue: T) => {
...
export function withGPUAcceleration<P extends object>(Component: React.ComponentType<P>) {
