  ...
  return (
    <div className={cn("relative", className)}>
      ...
      >
        {/* Background Slider */}
        <motion.div
          className="absolute top-1 bottom-1 w-1/2 bg-gradient-to-r from-blue-500/30 to-purple-500/30 backdrop-blur-sm rounded-lg border border-white/30"
          initial={false}
          animate={{
            x: mode === 'basic' ? 0 : '100%'
          }}
        ...
        <button
          ...
          className={cn(
            "relative z-10 flex items-center gap-2 px-6 py-3 rounded-lg transition-all duration-200",
            mode === 'basic' 
              ? "text-white" 
