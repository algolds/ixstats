  ...
  useEffect(() => {
    ...
    const calculateMetrics = (): EconomicMetric[] => {
      ...
      const socialSpending =
        (inputs.governmentSpending.education +
      ...
      return [
        ...
        },
        {
          ...
          trend:
            inputs.coreIndicators.realGDPGrowthRate > 2
              ? "up"
              : inputs.coreIndicators.realGDPGrowthRate > 0
                ? "stable"
                : "down",
      ...
      <GlassCardContent>
        <div className="space-y-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-foreground font-semibold">MyCountry Live Preview</h3>
              <p className="text-muted-foreground text-sm">Real-time economic vitality analysis</p>
            </div>
          </div>
              ...
              <div className="space-y-2">
                {advisorTips.slice(0, 2).map((tip) => {
                  ...
                  const getTipColor = (type: typeof tip.type) => {
                    switch (type) {
                      case "warning":
                        return "border-red-400/30 bg-red-400/10 text-red-300 dark:text-red-200";
                      case "suggestion":
                        return "border-blue-400/30 bg-blue-400/10 text-blue-300 dark:text-blue-200";
                      case "optimization":
                        return "border-green-400/30 bg-green-400/10 text-green-300 dark:text-green-200";
                    }
                  };
