    ...
    <div className={cn("space-y-4", className)}>
      ...
      <div className="space-y-2">
        ...
        >
          ...
          <motion.div
            className="absolute top-1 bottom-1 w-1/2 rounded-lg border border-white/30 bg-gradient-to-r from-purple-500/30 to-blue-500/30 backdrop-blur-sm"
            initial={false}
            animate={{
          ...
          <button
            ...
            className={cn(
              "relative z-10 flex flex-1 items-center justify-center gap-2 rounded-lg px-6 py-3 transition-all duration-200",
              style === "modern" ? "text-white" : "text-white/60 hover:text-white/80"
            )}
          >
            <Sparkles className="h-4 w-4" />
            <span className="text-sm font-medium">Modern Glass</span>
          </button>
          ...
          >
            ...
            <span className="text-sm font-medium">Classic Dense</span>
          </button>
        </motion.div>
      ...
      <div className="space-y-2">
        ...
        >
          ...
          <motion.div
            className="absolute top-1 bottom-1 w-1/2 rounded-lg border border-white/30 bg-gradient-to-r from-green-500/30 to-emerald-500/30 backdrop-blur-sm"
            initial={false}
            animate={{
              x: mode === "basic" ? 0 : "100%",
            }}
