...
export function SectorAnalysis({
  ...
  const economicStructure = [
    {
      name: "Primary Sector",
      value: data.economicStructure.primarySector,
      icon: Tractor,
      color: "green",
    },
    {
      name: "Secondary Sector",
      value: data.economicStructure.secondarySector,
      icon: Factory,
      color: "blue",
    },
    {
      name: "Tertiary Sector",
      value: data.economicStructure.tertiarySector,
      icon: Building2,
      color: "purple",
    },
    {
      name: "Quaternary Sector",
      value: data.economicStructure.quaternarySector,
      icon: Cpu,
      color: "emerald",
    },
  ];
  ...
  const getEconomyType = () => {
    const { primarySector, secondarySector, tertiarySector, quaternarySector } =
          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              ...
              <div className="flex items-center justify-between">
                ...
                <Badge variant="secondary">{data.patentsPerCapita.toFixed(2)}</Badge>
              </div>
              <div className="flex items-center justify-between">
            ...
            <CardContent className="space-y-3">
              ...
              <div className="flex items-center justify-between">
                ...
                <span className="text-sm font-medium">
                  {data.sectorProductivity.agriculture.toFixed(0)}
                </span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-sm">Manufacturing</span>
                <span className="text-sm font-medium">
                  {data.sectorProductivity.manufacturing.toFixed(0)}
                </span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-sm">Services</span>
                <span className="text-sm font-medium">
                  {data.sectorProductivity.services.toFixed(0)}
                </span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-sm">Technology</span>
                <span className="text-sm font-medium">
                  {data.sectorProductivity.technology.toFixed(0)}
                </span>
              </div>
            </CardContent>
          </Card>
