...
export const archetypes: CategorizedCountryArchetype[] = [
  ...
  },
  {
    ...
    filter: (country: RealCountryData) =>
      country.gdpPerCapita > 15000 &&
      country.gdpPerCapita < 40000 &&
  ...
  },
  {
    ...
    filter: (country: RealCountryData) =>
      country.population < 10000000 && country.gdpPerCapita > 25000,
  ...
  // Economic Performance Indicators (using available data)
  {
    ...
    color: "text-blue-600",
    filter: (country: RealCountryData) =>
      country.taxRevenuePercent !== undefined &&
      country.taxRevenuePercent > 15 &&
      country.taxRevenuePercent < 30,
  ...
  },
  {
    ...
    description:
      "Countries combining multiple legal traditions (common law, civil law, religious law).",
    icon: Scale,
    color: "text-purple-600",
    filter: (country: RealCountryData) => {
