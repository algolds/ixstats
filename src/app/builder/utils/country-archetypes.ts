...
const rawArchetypes = [
  ...
  // Government - Political Systems
  {
    ...
    filter: (country: RealCountryData) => {
      ...
      const democraticCountries = [
        ...
        "New Zealand", "Norway", "Portugal", "South Korea", "Spain", "Sweden", "Switzerland",
        "United Kingdom", "United States", "Costa Rica", "Uruguay", "Taiwan",
      ];
  ...
  },
  {
    ...
    filter: (country: RealCountryData) => {
      const federalCountries = [
        ...
        "Canada", "Ethiopia", "Germany", "India", "Iraq", "Malaysia", "Mexico", "Nepal",
        "Nigeria", "Pakistan", "Russia", "South Sudan", "Sudan", "Switzerland", "United States",
        "Venezuela",
      ];
  ...
  },
  {
    ...
    filter: (country: RealCountryData) => {
      const monarchies = [
        "Andorra", "Bahrain", "Belgium", "Bhutan", "Brunei", "Cambodia", "Denmark", "Japan",
        "Jordan", "Kuwait", "Lesotho", "Liechtenstein", "Luxembourg", "Malaysia", "Monaco",
        "Morocco", "Netherlands", "Norway", "Oman", "Qatar", "Saudi Arabia", "Spain", "Eswatini",
        "Sweden", "Thailand", "Tonga", "United Arab Emirates", "United Kingdom",
      ];
  ...
  },
  {
    ...
    filter: (country: RealCountryData) => {
      const commonLawCountries = [
        ...
        "Botswana", "Canada", "Cyprus", "Dominica", "Fiji", "Gambia", "Ghana", "Grenada",
        "Guyana", "Hong Kong", "India", "Ireland", "Israel", "Jamaica", "Kenya", "Kiribati",
        "Liberia", "Malawi", "Malaysia", "Malta", "Mauritius", "Myanmar", "Namibia", "Nauru",
        "New Zealand", "Nigeria", "Pakistan", "Papua New Guinea", "Saint Kitts and Nevis",
        ...
        "Trinidad and Tobago", "Tuvalu", "Uganda", "United Kingdom", "United States", "Vanuatu",
        "Zambia", "Zimbabwe",
      ];
  ...
  },
  {
    ...
    filter: (country: RealCountryData) => {
      const civilLawCountries = [
        "Albania", "Argentina", "Austria", "Belgium", "Bolivia", "Brazil", "Bulgaria", "Chile",
        ...
        "Haiti", "Honduras", "Hungary", "Iceland", "Indonesia", "Italy", "Japan", "Latvia",
        "Lithuania", "Luxembourg", "Mexico", "Netherlands", "Nicaragua", "Norway", "Panama",
...
export const archetypes: CategorizedCountryArchetype[] = rawArchetypes.map(withConsolidatedCategory);
