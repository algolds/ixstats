...
export function parseGovernmentAttributes(
  ...
  const powerPatterns: PatternMatch[] = [
    {
      pattern: /federal system|federal republic|federation of|federal structure/i,
      value: "federal",
      confidence: 85,
    },
    {
      pattern: /unitary state|unitary republic|unitary government/i,
      value: "unitary",
      confidence: 85,
    },
    {
      pattern: /centralized government|centralized state|highly centralized/i,
      value: "centralized",
      confidence: 80,
    },
  ...
  const decisionPatterns: PatternMatch[] = [
    ...
    {
      pattern: /dictator|absolute power|authoritarian rule|one-man rule|supreme leader/i,
      value: "autocratic",
      confidence: 85,
    },
    {
      pattern: /technocrats|expert rule|rule by experts|technocratic council/i,
      value: "technocratic",
      confidence: 80,
    },
    {
      pattern: /consensus-based|consensus decision|deliberative democracy/i,
      value: "consensus",
      confidence: 75,
    },
    {
      pattern: /oligarchy|ruling elite|powerful families|plutocracy/i,
      value: "oligarchic",
      confidence: 80,
    },
  ];
  ...
  collectAllMatches(
    ...
    [
      {
        pattern: /elections|voting|popular mandate|electoral process|ballot/i,
        value: "electoral",
        confidence: 80,
      },
      {
        pattern: /royal|hereditary|dynasty|monarch|bloodline|divine right/i,
        value: "traditional",
        confidence: 75,
      },
      {
        pattern: /economic growth|development|prosperity|rising living standards/i,
        value: "performance",
        confidence: 70,
      },
      {
        pattern: /charismatic leader|cult of personality|founding father|revolutionary leader/i,
        value: "charismatic",
        confidence: 70,
      },
      {
        pattern: /state religion|theocracy|religious law|divine mandate|mandate of heaven/i,
        value: "religious",
        confidence: 80,
      },
      {
        pattern: /constitutional|legal framework|rule of law|institutional continuity/i,
        value: "institutional",
        confidence: 70,
      },
    ],
  ...
  collectAllMatches(
    ...
    [
      {
        pattern: /independent judiciary|supreme court|constitutional court|judicial independence/i,
        value: "independent_judiciary",
        confidence: 85,
      },
      {
        pattern:
          /civil service|merit-based bureaucracy|professional civil service|career bureaucrats/i,
        value: "professional_bureaucracy",
        confidence: 80,
      },
      {
        pattern: /military rule|junta|military government|armed forces in power/i,
        value: "military_administration",
        confidence: 85,
      },
      {
        pattern: /one-party state|ruling party|dominant party|party-state/i,
        value: "partisan_institutions",
        confidence: 80,
      },
      {
        pattern: /technocratic agency|expert commission|independent regulator|regulatory body/i,
        value: "technocratic_agencies",
        confidence: 75,
      },
      {
        pattern:
          /digital government|e-government|online services|digital transformation of government/i,
        value: "digital_government",
        confidence: 75,
      },
    ],
    result.institutions
  ...
  collectAllMatches(
    ...
    [
      {
        pattern: /rule of law|constitutional government|due process|legal framework/i,
        value: "rule_of_law",
        confidence: 80,
      },
      {
      ...
      {
        pattern: /tax incentives|subsidies|economic incentives|fiscal policy/i,
        value: "economic_incentives",
        confidence: 70,
      },
      {
        pattern: /social pressure|conformity|social control|peer pressure|community enforcement/i,
        value: "social_pressure",
        confidence: 65,
      },
      {
        pattern: /military enforcement|martial law|armed enforcement|security forces/i,
        value: "military_enforcement",
        confidence: 80,
      },
    ],
  ...
  collectAllMatches(
    ...
    [
      {
        pattern: /free market|market economy|laissez-faire|market-driven/i,
        value: "free_market",
        confidence: 80,
      },
      {
        pattern: /planned economy|central planning|command economy|state planning/i,
      ...
      {
        pattern: /state-owned|state capitalism|nationalized industries|state-controlled economy/i,
        value: "state_capitalism",
        confidence: 80,
      },
      {
        pattern: /resource-based economy|resource-dependent|commodity-driven/i,
        value: "resource_based",
        confidence: 75,
      },
      {
        pattern: /knowledge economy|innovation-driven|tech economy|digital economy/i,
  ...
  collectAllMatches(
    ...
    [
      {
        pattern: /welfare state|social safety net|social welfare/i,
        value: "welfare_state",
        confidence: 80,
      },
      {
        pattern: /universal healthcare|national health service|NHS|publicly funded healthcare/i,
      ...
      {
        pattern: /social safety net|social security|unemployment benefits|social insurance/i,
        value: "social_safety_net",
        confidence: 75,
      },
      {
        pattern: /labor rights|worker protection|workers' rights|employment protection/i,
        value: "worker_protection",
        confidence: 75,
      },
      {
        pattern: /environmental protection|green policy|environmental regulation|climate policy/i,
        value: "environmental_protection",
        confidence: 75,
      },
      {
        pattern: /cultural preservation|heritage protection|cultural policy|national identity/i,
        value: "cultural_preservation",
        confidence: 70,
      },
      {
        pattern: /minority rights|indigenous rights|equal rights|anti-discrimination/i,
        value: "minority_rights",
        confidence: 75,
      },
    ],
  ...
  collectAllMatches(
    ...
    [
      {
        pattern: /e-government|digital services|online government services/i,
        value: "digital_government",
        confidence: 80,
      },
      {
        pattern: /e-governance|digital governance|government technology/i,
        value: "e_governance",
        confidence: 75,
      },
      {
        pattern: /decentralization|local government|devolution|regional autonomy/i,
        value: "administrative_decentralization",
        confidence: 80,
      },
      {
        pattern: /merit-based civil service|meritocracy|competitive examination/i,
        value: "merit_based_system",
        confidence: 80,
      },
      {
        pattern: /performance management|KPIs|performance metrics|results-based/i,
        value: "performance_management",
        confidence: 70,
      },
      {
        pattern: /strategic planning|five-year plan|national development plan|long-term strategy/i,
  ...
  const intlPatterns: PatternMatch[] = [
    {
      pattern: /UN\b|multilateral|international organizations|global governance|United Nations/i,
      value: "multilateral",
      confidence: 80,
    },
    {
      pattern: /bilateral treaties|bilateral agreements|bilateral relations/i,
      value: "bilateral",
      confidence: 75,
    },
    {
      pattern: /regional bloc|regional organization|regional integration|regional power/i,
      value: "regional",
      confidence: 75,
    },
    {
      pattern: /non-aligned|isolationist|non-interference|closed country|self-reliance/i,
      value: "isolationist",
      confidence: 75,
    },
  ];
  ...
  const weights: { key: string; weight: number; confidence: number }[] = [
    ...
    { key: "decision", weight: 15, confidence: result.decisionProcessConfidence },
    {
      ...
      weight: 10,
      confidence:
        result.legitimacySources.length > 0
          ? Math.max(...result.legitimacySources.map((l) => l.confidence))
          : 0,
    },
    {
      key: "institutions",
      ...
      confidence:
        result.institutions.length > 0
          ? Math.max(...result.institutions.map((i) => i.confidence))
          : 0,
    },
    {
      key: "control",
      weight: 10,
      confidence:
        result.controlMechanisms.length > 0
          ? Math.max(...result.controlMechanisms.map((c) => c.confidence))
          : 0,
    },
    {
      key: "economic",
      weight: 10,
      confidence:
        result.economicGovernance.length > 0
          ? Math.max(...result.economicGovernance.map((e) => e.confidence))
          : 0,
    },
    {
      key: "social",
      weight: 10,
      confidence:
        result.socialPolicies.length > 0
          ? Math.max(...result.socialPolicies.map((s) => s.confidence))
          : 0,
    },
    {
      key: "administrative",
      weight: 10,
      confidence:
        result.administrativeFeatures.length > 0
          ? Math.max(...result.administrativeFeatures.map((a) => a.confidence))
          : 0,
    },
