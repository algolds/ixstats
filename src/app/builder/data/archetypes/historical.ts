...
export const historicalArchetypes = new Map<string, EconomicArchetype>([
  ...
  [
    "british-empire",
    {
      ...
      description:
        "Global maritime empire with colonial trade, industrial revolution, and naval supremacy (1700s-1900s)",
      ...
      historicalContext:
        "Dominant global power from 1700s-1900s through naval supremacy, industrial revolution, and colonial expansion",
  ...
  [
    "venetian-republic",
    {
      ...
      description:
        "Maritime trading republic with banking, shipbuilding, and Mediterranean commerce dominance (800s-1700s)",
      ...
      historicalContext:
        "Dominant Mediterranean power from 800s-1700s through maritime trade, banking, and cultural achievements",
  ...
  [
    "hanseatic-league",
    {
      ...
      description:
        "Northern European trading confederation with Baltic commerce, guild systems, and merchant cooperation (1200s-1600s)",
      ...
      historicalContext:
        "Dominant Northern European trading network from 1200s-1600s through merchant cooperation and guild systems",
      modernExamples: [
        "Hamburg, Germany",
        "Lübeck, Germany",
        "Bremen, Germany",
  ...
  [
    "dutch-golden-age",
    {
      ...
      description:
        "Maritime trading power with banking innovation, art patronage, and global commerce (1600s-1700s)",
      region: "Netherlands",
      characteristics: [
      ...
      historicalContext:
        "Golden age of prosperity from 1600s-1700s through maritime trade, banking innovation, and cultural achievements",
      modernExamples: [
  ...
  [
    "industrial-revolution",
    {
      ...
      description:
        "Mass production economy with steam power, factory systems, and urbanization (1700s-1900s)",
      ...
      historicalContext:
        "Revolutionary transformation from 1700s-1900s through steam power, factory systems, and mass production",
  ...
  [
    "soviet-command",
    {
      ...
      description:
        "Centralized planned economy with state ownership, five-year plans, and industrial development (1920s-1990s)",
      region: "Soviet Union",
      characteristics: [
      ...
      historicalContext:
        "Centralized planned economy from 1920s-1990s with rapid industrialization and social transformation",
      modernExamples: [
        "Moscow, Russia",
  ...
  [
    "american-gilded-age",
    {
      ...
      description:
        "Rapid industrialization with railroad expansion, steel production, and corporate consolidation (1870s-1900s)",
      ...
      historicalContext:
        "Rapid economic expansion from 1870s-1900s through industrialization, railroads, and corporate growth",
  ...
  [
    "french-mercantilism",
    {
      ...
      description:
        "State-directed economy with royal monopolies, luxury goods, and colonial expansion (1600s-1700s)",
      region: "France",
      characteristics: [
      ...
      historicalContext:
        "State-directed economy from 1600s-1700s with royal monopolies, luxury production, and colonial expansion",
  ...
  [
    "ottoman-empire",
    {
      ...
      description:
        "Multi-ethnic empire with trade routes, agricultural production, and administrative efficiency (1300s-1900s)",
      ...
      historicalContext:
        "Multi-continental empire from 1300s-1900s with trade control, agricultural production, and administrative efficiency",
  ...
  [
    "chinese-ming-dynasty",
    {
      ...
      description:
        "Agricultural empire with bureaucratic administration, porcelain production, and maritime exploration (1368-1644)",
      region: "China",
      characteristics: [
      ...
      historicalContext:
        "Imperial dynasty from 1368-1644 with bureaucratic administration, agricultural development, and cultural achievements",
