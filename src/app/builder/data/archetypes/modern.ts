...
export const modernArchetypes = new Map<string, EconomicArchetype>([
  [
    "silicon-valley",
    {
      ...
      description:
        "Innovation-driven economy with strong tech sector, venture capital, and entrepreneurial culture",
      ...
      historicalContext:
        "Emerged from defense industry in 1950s-60s, accelerated by semiconductor revolution and internet boom",
      modernExamples: [
  ...
  [
    "nordic",
    {
      ...
      name: "Nordic Model",
      description:
        "Social market economy with high taxes, extensive welfare, and strong social cohesion",
      ...
      historicalContext:
        "Developed post-WWII with strong labor movements and social democratic governance",
      modernExamples: [
        "Copenhagen, Denmark",
        "Stockholm, Sweden",
        "Oslo, Norway",
  ...
  [
    "asian-tiger",
    {
      ...
      description:
        "Export-oriented development with strong state guidance and rapid industrialization",
      ...
      historicalContext:
        "Developed rapidly from 1960s-90s through export-oriented industrialization and state guidance",
  ...
  [
    "german-social-market",
    {
      ...
      description:
        "Balanced approach combining market efficiency with social responsibility and worker participation",
      region: "Germany",
      characteristics: [
      ...
      historicalContext:
        "Developed post-WWII combining free market principles with social responsibility and worker rights",
      modernExamples: [
        "Munich, Germany",
        "Stuttgart, Germany",
        "Frankfurt, Germany",
  ...
  [
    "singapore",
    {
      ...
      description:
        "Highly efficient city-state with strategic state planning, open markets, and strict governance",
      region: "Singapore",
      characteristics: [
      ...
      historicalContext:
        "Developed from 1960s through strategic planning, foreign investment, and efficient governance",
  ...
  [
    "swiss",
    {
      ...
      name: "Swiss Model",
      description:
        "High-value precision economy with strong banking, pharmaceuticals, and manufacturing excellence",
      region: "Switzerland",
      characteristics: [
      ...
      historicalContext:
        "Developed through neutrality, federalism, and focus on high-value precision industries",
      modernExamples: [
        "Zurich, Switzerland",
        "Basel, Switzerland",
        "Geneva, Switzerland",
  ...
  [
    "japanese",
    {
      ...
      name: "Japanese Model",
      description:
        "Technology-driven economy with strong manufacturing, innovation, and lifetime employment culture",
      region: "Japan",
      characteristics: [
      ...
      historicalContext:
        "Post-WWII economic miracle through manufacturing, technology, and export-oriented growth",
  ...
  [
    "australian",
    {
      ...
      description:
        "Resource-rich economy with strong mining, agriculture, and service sectors in a stable democratic framework",
      region: "Australia",
      characteristics: [
      ...
      historicalContext:
        "Developed from resource extraction and agriculture, now diversified into services and technology",
      modernExamples: [
        "Sydney, Australia",
        "Melbourne, Australia",
        "Perth, Australia",
  ...
  [
    "brazilian",
    {
      ...
      description:
        "Emerging market economy with strong agriculture, mining, and growing technology sector in a large domestic market",
      region: "Brazil",
      characteristics: [
      ...
      historicalContext:
        "Emerging from commodity-based economy to diversified industrial and service economy",
      modernExamples: [
        "São Paulo, Brazil",
  ...
  [
    "canadian",
    {
      ...
      name: "Canadian Model",
      description:
        "Resource-rich economy with strong social programs, multiculturalism, and technology sector in a federal system",
      region: "Canada",
      characteristics: [
        "Abundant natural resources",
      ...
      historicalContext:
        "Developed from resource extraction to diversified economy with strong social programs",
      modernExamples: [
        "Toronto, Canada",
        "Vancouver, Canada",
        "Montreal, Canada",
