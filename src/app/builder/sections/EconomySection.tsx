...
export function EconomySection({
  ...
  const sustainabilityScore = useMemo(
    () => calculateSustainabilityScore(economyData),
    [economyData]
  );
  ...
  const metrics: Metric[] = useMemo(() => {
    ...
    return [
      ...
      },
      {
        ...
        icon:
          economicHealthScore >= 70
            ? CheckCircle
            : economicHealthScore < 40
              ? AlertTriangle
              : Gauge,
      ...
      <div className="md:col-span-2">
        <EnhancedPieChart
          data={[
            {
              name: "Agriculture",
              value: economyData.sectors.sectorGDPContribution.agriculture,
              color: "emerald",
            },
            {
              name: "Industry",
              value: economyData.sectors.sectorGDPContribution.manufacturing,
              color: "blue",
            },
            {
              name: "Services",
              value:
                economyData.sectors.sectorGDPContribution.finance +
                economyData.sectors.sectorGDPContribution.professional,
              color: "purple",
            },
            {
              name: "Technology",
              value: economyData.sectors.sectorGDPContribution.information,
              color: "gold",
            },
          ]}
          dataKey="value"
      ...
      <div className="md:col-span-2">
        <EnhancedBarChart
          data={[
            {
              name: "Lower Class",
              value: economyData.income.incomeClasses.lowerClass.percent,
              color: "red",
            },
            {
              name: "Middle Class",
              value: economyData.income.incomeClasses.middleClass.percent,
              color: "blue",
            },
            {
              name: "Upper Class",
              value: economyData.income.incomeClasses.upperClass.percent,
              color: "emerald",
            },
          ]}
          xKey="name"
