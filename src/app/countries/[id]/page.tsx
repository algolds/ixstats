                ...
                <Tabs defaultValue="overview" className="w-full relative z-10">
                          ...
                          <CardContent>
                              ...
                              <div>
                                ...
                                {country.analytics.tierChangeProjection && (
                                  <div className="mt-4">
                                    ...
                                    <p className="text-sm">Expected to reach next economic tier (GDPPC ≥ ${country.analytics.tierChangeProjection.nextTier.toLocaleString()}) in <span className="font-mono">{country.analytics.tierChangeProjection.years}</span> year(s).</p>
                                  </div>
                                )}
                              </div>
                            </div>
                            ...
                            <div className="mt-6">
                              ...
                              {country.dmInputs && country.dmInputs.length > 0 ? (
                                <ul className="text-sm space-y-1">
                                  {country.dmInputs.map((dm: DmInputs, i: number) => (
                                    <li key={i}>
                  ...
                  <TabsContent value="government" className="mt-4">
                    ...
                    <div className="space-y-6 relative z-10">
                      ...
                      />
                      <GovernmentSpending
                        spendingData={editedEconomyData?.spending ?? { totalSpending: 0, spendingGDPPercent: 0, spendingPerCapita: 0, spendingCategories: [], deficitSurplus: 0 }}
                        nominalGDP={editedEconomyData?.core?.nominalGDP ?? 0}
                        totalPopulation={editedEconomyData?.core?.totalPopulation ?? 0}
