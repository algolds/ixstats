  ...
  return (
    ...
    >
      <Section title="Dashboard Sections">
        <ul className="list-disc space-y-2 pl-6">
          <li>
            ...
            `api.intelligence.getExecutiveDashboard`.
          </li>
          <li>
            Hot issues, opportunities, and strategic initiatives aggregated from intelligence and
      ...
      <Section title="How to Use It">
        <InfoBox title="Tips">
          <ul className="list-disc space-y-1 pl-6">
            ...
            <li>
              Use call-to-action buttons to jump into ThinkPages, compliance workflows, or policy
              proposals.
            </li>
      ...
      <Section title="Customization">
        <ul className="list-disc space-y-2 pl-6">
          <li>
            Dashboard layout and widgets live in `src/app/mycountry/intelligence/_components`.
          </li>
      ...
      <InfoBox title="Related Articles">
        <ul className="list-disc space-y-1 pl-6">
          <li>
            <Radar className="inline h-4 w-4" /> `/help/intelligence/metrics` – deep dive into each
            metric.
          </li>
          <li>
            <Globe className="inline h-4 w-4" /> `/help/diplomacy/embassies` – diplomacy
            connections.
          </li>
        </ul>
      </InfoBox>
