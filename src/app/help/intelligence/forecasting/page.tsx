  ...
  return (
    ...
    >
      ...
      <InfoBox title="Related Material">
        <ul className="list-disc pl-6 space-y-1">
          <li><CalendarClock className="inline h-4 w-4" /> `/help/economy/modeling` – economic scenario planning.</li>
          <li><Sparkle className="inline h-4 w-4" /> `docs/systems/intelligence.md` – implementation notes.</li>
        </ul>
      </InfoBox>
    </ArticleLayout>
  );
