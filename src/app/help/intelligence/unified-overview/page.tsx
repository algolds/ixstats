    ...
    >
      <Section title="Why We Unified">
        <ul className="list-disc pl-6 space-y-2">
          <li>Single router (`unified-intelligence.ts`) replaces the older `eci` and `sdi` endpoints for strategic data.</li>
          <li>Provides consistent payloads for executive dashboards, defense readiness, and compliance.</li>
      ...
      <Section title="Migration Notes">
        <InfoBox title="Key Changes">
          <ul className="list-disc pl-6 space-y-1">
            ...
            <li>Documentation updated in `docs/systems/intelligence.md` and `docs/reference/api.md`.</li>
          </ul>
        </InfoBox>
      </Section>
      ...
      <Section title="Maintaining the Unified Layer">
        <ul className="list-disc pl-6 space-y-2">
          <li>Ensure new intelligence sources plug into the unified router rather than reintroducing siloed feeds.</li>
      ...
      <InfoBox title="Related Articles">
        <ul className="list-disc pl-6 space-y-1">
          <li><Merge className="inline h-4 w-4" /> `/help/intelligence/executive-operations` – operations built on the unified feed.</li>
          <li><Server className="inline h-4 w-4" /> `/help/technical/api` – API layer overview.</li>
        </ul>
      </InfoBox>
    </ArticleLayout>
  );
