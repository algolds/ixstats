    ...
    >
      <Section title="Metric Families">
        <ul className="list-disc pl-6 space-y-2">
          <li><strong>Vitality Scores:</strong> Economic, population, diplomatic, security, social.</li>
          <li><strong>Risk & Opportunity Index:</strong> Derived from notifications, missions, and economic signals.</li>
          <li><strong>Compliance Radar:</strong> Tracks overdue tasks and upcoming milestones.</li>
        </ul>
      </Section>
      ...
      <InfoBox title="Further Reading">
        <ul className="list-disc pl-6 space-y-1">
          <li><BarChart2 className="inline h-4 w-4" /> `docs/systems/intelligence.md` – formulas & integrations.</li>
          <li><Activity className="inline h-4 w-4" /> `/help/intelligence/alerts` – responding to metric-driven alerts.</li>
        </ul>
      </InfoBox>
    </ArticleLayout>
  );
