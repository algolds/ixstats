      ...
      <ContentCard>
        <Section title="What Your Metrics Mean">
          <p className="mb-4">
            ...
            These are organized into three main families so you can quickly assess where things stand
            and where action is needed.
          </p>
          <ul className="list-disc space-y-3 pl-6">
            <li>
              <strong>Vitality Scores:</strong> Five core health ratings that reflect how your nation
              is performing right now:
              <ul className="mt-1 list-disc space-y-1 pl-6 text-sm">
                <li><strong>Economic:</strong> GDP growth, trade balance, and fiscal health.</li>
                <li><strong>Population:</strong> Growth rate, demographics, and social stability.</li>
                <li><strong>Diplomatic:</strong> Relationship strength, active treaties, and global standing.</li>
                <li><strong>Security:</strong> Military readiness, internal stability, and threat levels.</li>
                <li><strong>Social:</strong> Public satisfaction, cultural development, and quality of life.</li>
              </ul>
            </li>
            <li>
              <strong>Risk &amp; Opportunity Index:</strong> A dynamic score that highlights emerging
              threats and favorable conditions based on your diplomatic missions, economic trends,
              and recent events. When this index spikes, pay attention -- something significant is
              developing.
            </li>
            <li>
        ...
        <Section title="How Metrics Are Calculated">
          <InfoBox title="Behind the Numbers">
            <p className="mb-2">
              Your metrics are calculated automatically from your nation&apos;s live data. The system
              analyzes your economic performance, diplomatic relationships, military posture, and
              social indicators to produce composite scores.
            </p>
            <ul className="list-disc space-y-1 pl-6">
              <li>
                Scores update in real time as your nation&apos;s situation changes.
              </li>
              <li>
                Historical data is preserved so you can track trends and see how your decisions
                have affected outcomes over time.
              </li>
              <li>
      ...
      <ContentCard>
        <Section title="Acting on Your Metrics">
          <ul className="list-disc space-y-2 pl-6">
            ...
            <li>
              <strong>Use quick actions:</strong> When a vitality score drops, use the action buttons
              on the metric card to jump straight into a policy draft, diplomatic outreach, or
              defense adjustment.
            </li>
            <li>
