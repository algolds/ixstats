      ...
      <ContentCard>
        ...
        <Section title="Setting Up Taxes">
          <InfoBox title="Tax Builder Steps">
            <ol className="list-decimal space-y-2 pl-6">
              <li>
                <Settings className="inline h-4 w-4" /> <strong>Configuration:</strong> Choose your
                overall tax system type and set the base rate parameters that shape your fiscal
                framework
              </li>
              <li>
              ...
              <li>
                <Calculator className="inline h-4 w-4" /> <strong>Preview Revenue:</strong> See
                estimated revenue based on your current economy before you commit. Try different
                configurations to find the right balance.
              </li>
            </ol>
          </InfoBox>
        </Section>
        ...
        <Section title="Tax Types Available">
          <ul className="list-disc space-y-2 pl-6">
            <li>
              <strong>Income Taxes:</strong> Progressive brackets on personal income with
              configurable rates and thresholds
            </li>
            <li>
              <strong>Corporate Taxes:</strong> Business income taxation with sector-specific
              adjustments
            </li>
            <li>
              <strong>Value Added Tax (VAT):</strong> Consumption-based tax with exemptions for
              essentials
            </li>
            <li>
              <strong>Property Taxes:</strong> Real estate and asset taxation
            </li>
            <li>
              <strong>Capital Gains:</strong> Taxes on investment returns with holding period
              adjustments
            </li>
            <li>
              <strong>Specialized Taxes:</strong> Tariffs, excise duties, environmental levies, and
        ...
        <Section title="How Taxes Connect to Your Nation">
          ...
          <ul className="mt-2 list-disc space-y-2 pl-6">
            ...
            <li>
              ...
              alongside government and economic effectiveness, giving you a unified view of how well
              your nation is configured.
            </li>
          </ul>
        </Section>

        <Section title="Revenue Analysis Tools">
          <p>The Tax Calculator helps you understand and optimize your revenue:</p>
          <ul className="mt-2 list-disc space-y-2 pl-6">
