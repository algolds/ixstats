    ...
    >
      <ContentCard>
        <Section title="Pack Store">
          <p>
            ...
            purchase card packs. Each pack type has a fixed IxCredits price, a guaranteed number
            of cards, and minimum rarity guarantees.
          </p>
        </Section>
        ...
        <Section title="Opening Experience">
          ...
          <ul className="mt-2 list-disc space-y-2 pl-6">
            ...
            <li>
              <strong>Stage 4 - Quick Actions:</strong> After all cards are revealed, choose what
              to do: keep in collection, mark for trading, or view full card details.
            </li>
          </ul>
        </Section>
      </ContentCard>
      ...
      <ContentCard>
        ...
        <WarningBox title="IxCredits Requirement">
          You must have enough IxCredits to purchase a pack. If your balance is insufficient,
          the purchase button will be disabled. Earn IxCredits through gameplay actions, daily
          logins, and achievements.
        </WarningBox>
        ...
        <InfoBox title="Related Articles">
          <ul className="list-disc space-y-1 pl-6">
            ...
            <li><Link href="/help/vault/ixcredits" className="text-blue-600 hover:underline dark:text-blue-400">IxCredits Economy</Link> - How to earn IxCredits</li>
            <li><Link href="/help/vault/trading" className="text-blue-600 hover:underline dark:text-blue-400">Trading &amp; Marketplace</Link> - Trading cards on the marketplace</li>
          </ul>
        </InfoBox>
      </ContentCard>
    </ArticleLayout>
