  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-slate-100 dark:from-slate-950 dark:via-blue-950 dark:to-slate-900">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8"><div className="flex items-center gap-3 mb-4"><Database className="w-8 h-8 text-blue-600 dark:text-blue-400" /><h1 className="text-4xl font-bold text-slate-900 dark:text-white">Database Schema</h1></div><p className="text-xl text-slate-600 dark:text-slate-300">Prisma ORM with 124 models and 8 migrations</p></div>
        <div className="prose prose-slate dark:prose-invert prose-blue max-w-none"><div className="bg-white border border-slate-200 dark:bg-white/5 dark:border-white/10 rounded-xl p-8 backdrop-blur-xl space-y-6">
          <section><h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-4">Schema Overview</h2><p className="text-slate-700 dark:text-slate-300 leading-relaxed">IxStats database uses Prisma ORM with a comprehensive schema covering all platform features. 124 models across 8 migrations handle countries, economics, government, intelligence, diplomacy, and social features. See <code>prisma/schema.prisma</code> for the authoritative schema.</p></section>
