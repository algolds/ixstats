    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-slate-100 dark:from-slate-950 dark:via-blue-950 dark:to-slate-900">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="prose prose-slate dark:prose-invert prose-blue max-w-none"><div className="bg-white border border-slate-200 dark:bg-white/5 dark:border-white/10 rounded-xl p-8 backdrop-blur-xl space-y-6">
          ...
          <section>
            <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-4">Conventions & Validation</h2>
            <ul className="space-y-2 text-slate-700 dark:text-slate-300">
              <li>• <strong>Naming:</strong> Queries use <span className="font-mono">useQuery</span>, mutations use <span className="font-mono">useMutation</span>; procedures are namespaced by router (e.g., <span className="font-mono">countries.getBySlug</span>).</li>
              <li>• <strong>Input Validation:</strong> All procedures validate inputs with Zod schemas at the router layer for end-to-end type safety.</li>
              <li>• <strong>Auth & RBAC:</strong> Routers are protected by middleware (Clerk + role checks); sensitive procedures require appropriate roles.</li>
            </ul>
          </section>
