      ...
      <ContentCard>
        <Section title="Stability Indicators">
          <ul className="list-disc space-y-2 pl-6">
            ...
            <li>
              Compliance tasks fire when thresholds are crossed (e.g., protests, strikes, coup
              risk).
            </li>
      ...
      <ContentCard>
        <WarningBox title="Operational Advice">
          <ul className="list-disc space-y-1 pl-6">
            ...
            <li>
              <LayoutList className="inline h-4 w-4" /> Document context in compliance notes for
              audit trails.
            </li>
          </ul>
        </WarningBox>
