    ...
    >
      <Section title="Component Categories">
        <ul className="list-disc space-y-2 pl-6">
          <li>
            Power Distribution, Decision Processes, Legitimacy Sources, Institutions, and Control
            Mechanisms.
          </li>
          <li>
            Components live in both UI (`src/components/government/atoms`) and Prisma enums
            (`ComponentType`).
          </li>
      ...
      <Section title="Selecting Components">
        <InfoBox title="Builder & Editor">
          <ul className="list-disc space-y-1 pl-6">
            <li>
              Use the `UnifiedAtomicComponentSelector` to pick combinations; tooltips summarise
              effects.
            </li>
      ...
      <Section title="Operational Impact">
        <ul className="list-disc space-y-2 pl-6">
          <li>
            Economic, policy, and intelligence routers reference selected components to adjust
            indices.
          </li>
          <li>
            Achievements and compliance tasks look for specific configurations (e.g., crisis-ready
            governments).
          </li>
          <li>
            Use ThinkPages to narrate constitutional reforms alongside these mechanical changes.
          </li>
        </ul>
      </Section>
      ...
      <InfoBox title="Further Reading">
        <ul className="list-disc space-y-1 pl-6">
          <li>
            <Link2 className="inline h-4 w-4" /> `docs/systems/builder.md` – atomic component
            integration.
          </li>
          <li>
            <Activity className="inline h-4 w-4" /> `docs/systems/mycountry.md` – how dashboards
            consume atomic data.
          </li>
        </ul>
      </InfoBox>
