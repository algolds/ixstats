    ...
    >
      ...
      <Section title="What Are Embassies?">
        <p className="mb-4 text-slate-700 dark:text-slate-300">
          ...
          intelligence about the host nation. A well-maintained embassy network is the foundation of
        ...
        <div className="grid gap-3 sm:grid-cols-3">
          <div className="rounded-lg border border-slate-200 p-3 dark:border-white/10">
            ...
            <p className="text-sm text-slate-600 dark:text-slate-400">
              Embassies increase your influence with the host nation, improving relationship strength
              over time.
            </p>
          </div>
          <div className="rounded-lg border border-slate-200 p-3 dark:border-white/10">
            ...
            <p className="text-sm text-slate-600 dark:text-slate-400">
              Active embassies unlock trade bonuses and make economic agreements more favourable for
              your nation.
            </p>
          </div>
          <div className="rounded-lg border border-slate-200 p-3 dark:border-white/10">
      ...
      <Section title="How to Establish a New Embassy">
        <ol className="list-decimal space-y-3 pl-6 text-slate-700 dark:text-slate-300">
          <li>
            ...
            the <strong>Establish Embassy</strong> button. Browse or search for the country where you
            want diplomatic presence.
          </li>
          <li>
            <strong>Review the details.</strong> You will see the current relationship status with
            that nation, any existing diplomatic ties, and the estimated benefits of establishing an
            embassy there.
          </li>
          <li>
            <strong>Confirm and establish.</strong> Once you confirm, your embassy will be created.
            It starts at a basic level and can be upgraded over time as your relationship with the
            host nation grows.
          </li>
          <li>
      ...
      <Section title="Managing Your Embassy Network">
        ...
        <ul className="list-disc space-y-2 pl-6 text-slate-700 dark:text-slate-300">
          ...
          <li>
            ...
            improves, you can upgrade your embassy to unlock higher-tier benefits like enhanced trade
            agreements and deeper intelligence access.
          </li>
          <li>
            <Shield className="mr-1 inline h-4 w-4 text-blue-600 dark:text-blue-400" />
            <strong>Watch for alerts</strong> &mdash; If a host nation&apos;s stability changes or a
            diplomatic incident occurs, you will receive alerts. Respond promptly to protect your
            embassy and maintain your influence.
          </li>
        </ul>
      </Section>
      </ContentCard>
          ...
          <table className="w-full text-sm">
            ...
            <tbody className="text-slate-700 dark:text-slate-300">
              ...
              <tr className="border-b border-slate-100 dark:border-white/5">
                ...
                <td className="py-2">
                  Embassies serve as a base for diplomatic missions. Having an embassy in a country
                  improves mission success rates there.
                </td>
              </tr>
              <tr>
      ...
      <Section title="Best Practices">
        <ul className="list-disc space-y-2 pl-6 text-slate-700 dark:text-slate-300">
          <li>
            <strong>Pair embassy expansion with trade or cultural programmes.</strong> Establishing
            an embassy alongside a trade agreement or cultural exchange amplifies the benefits of
            both.
          </li>
          <li>
            <strong>Prioritise nations that matter to your strategy.</strong> You do not need
            embassies everywhere. Focus on key allies, trading partners, and rivals you want to keep
            an eye on.
          </li>
          <li>
          ...
          <li>
            <strong>Check the leaderboard.</strong> Diplomatic achievements are tracked on the global
            leaderboard. A strong embassy network contributes to your nation&apos;s overall ranking.
          </li>
        </ul>
      </Section>
