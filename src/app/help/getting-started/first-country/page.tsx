    ...
    >
      ...
      <Section title="Step 1: Open the Country Builder">
        ...
        <ul className="mt-2 list-disc space-y-2 pl-6">
          ...
          <li>
            <strong>Import from IxWiki:</strong> Pull in baseline data from an existing wiki article
      ...
      <Section title="Step 2: Work Through Each Section">
        <ol className="list-decimal space-y-2 pl-6">
          <li>
            <strong>Identity:</strong> Set your nation&rsquo;s name, flag, motto, and basic details.
          </li>
          <li>
      ...
      <Section title="Step 3: Review and Save">
        <p>
          ...
          your choices and tweak anything that does not look right. The builder also suggests policy
          recommendations based on your configuration -- these are great starting points for fine-tuning
          your nation later.
        </p>
      </Section>
      ...
      <Section title="Helpful Tools Along the Way">
        <InfoBox title="Builder Tips">
          <ul className="list-disc space-y-1 pl-6">
            <li>
              <strong>Wiki Import:</strong> If your nation already has an IxWiki page, you can pull
              in that data as a starting point and customize from there.
            </li>
            <li>
              <strong>Component Synergies:</strong> Certain government and economic components work
              better together. Look for synergy indicators as you build -- they give your nation
              real performance bonuses. See the{" "}
            ...
            <li>
              <strong>Policy Advisor:</strong> As you fill in each section, the builder will suggest
              optimizations and flag potential conflicts in your setup.
            </li>
          </ul>
        </InfoBox>
      </Section>
