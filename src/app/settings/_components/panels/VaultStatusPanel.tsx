    ...
    <div className="space-y-6">
      ...
      >
        ...
        >
          <button
            ...
            data-cuelume-press="soft"
            className="facet-interactive rounded-xl bg-foreground px-3.5 py-1.5 text-xs font-bold text-background shadow-xs transition-all hover:bg-foreground/90 active:scale-[0.98] disabled:opacity-50"
          >
      ...
      >
        ...
        <SettingsRow
          ...
          glyphClass="bg-muted/60 text-foreground"
        >
          <span className="rounded-xl border border-border/60 bg-muted/40 px-3 py-1.5 text-xs font-semibold text-foreground">
