import { StatsReport as BarChart3, Crown, Globe, Building } from "iconoir-react";
    ...
    <div className="facet-surface facet-refraction overflow-hidden rounded-3xl p-1 transition-all duration-500 hover:shadow-2xl">
      <div className="rounded-[calc(1.5rem-1px)] bg-white/40 p-6 dark:bg-slate-900/40">
        ...
        <div className="space-y-2">
          <Link
            href={"/dashboard"}
            className="facet-interactive group flex w-full items-center rounded-xl px-4 py-3 text-sm font-medium text-slate-700 transition-all hover:bg-white/60 dark:text-slate-300 dark:hover:bg-slate-800/60"
          >
