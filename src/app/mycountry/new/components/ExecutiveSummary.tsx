            ...
            >
              ...
              <div className="space-y-2">
                {nationalHealth.criticalAlerts.slice(0, 3).map((alert, index) => (
                  <div
                    key={alert.id ? `alert-${alert.id}` : `alert-fallback-${index}`}
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
              {leadershipMetrics.map((metric, index) => {
                ...
                return (
                  <motion.div
                    key={metric.id ? `metric-${metric.id}` : `metric-fallback-${index}`}
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-2">
                {nationalHealth.keyOpportunities.slice(0, 3).map((opportunity, index) => (
                  <div
                    key={opportunity.id ? `opportunity-${opportunity.id}` : `opportunity-fallback-${index}`}
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-2">
                {temporalContext.recentChanges.slice(0, 3).map((change, index) => (
                  <div
                    key={change.id ? `change-${change.id}` : `change-fallback-${index}`}
