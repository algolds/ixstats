...
export const CONTENT_HIERARCHY: ContentSection[] = [
  {
    ...
    purpose:
      "Core country identification, flag, and basic demographics that establish national presence",
    priority: "critical",
    audience: "both",
    dataType: "static",
...

  {
    ...
    children: [
      ...
      },
      {
        ...
        purpose:
          "Composite health scores across economic, social, diplomatic, and governance dimensions",
        priority: "high",
        audience: "both",
        dataType: "real-time",
        updateFrequency: "immediate",
    ...
    children: [
      {
        ...
        purpose:
          "Real-time strategic intelligence, threats, opportunities, and actionable insights",
        priority: "critical",
        audience: "executive",
        dataType: "real-time",
        updateFrequency: "immediate",
    ...
    children: [
      {
        ...
        purpose:
          "Major accomplishments, milestones, and recognition earned through national development",
        priority: "high",
        audience: "public",
        dataType: "dynamic",
        updateFrequency: "daily",
      ...
      },
      {
        ...
        purpose:
          "Comparative global standing, regional position, and tier-based performance metrics",
        priority: "high",
        audience: "public",
        dataType: "dynamic",
        updateFrequency: "daily",
...

  {
    ...
    purpose:
      "Deep analytical data, trends, and comparative intelligence for informed decision-making",
    priority: "medium",
    audience: "both",
    dataType: "dynamic",
...

  {
    ...
    purpose:
      "Technical infrastructure, system status, and integration with broader IxStats ecosystem",
    priority: "low",
    audience: "both",
    dataType: "dynamic",
    updateFrequency: "immediate",
...
export function getContentByAudience(audience: "public" | "executive" | "both") {
  return CONTENT_HIERARCHY.filter(
    (section) => section.audience === audience || section.audience === "both"
  );
}
...
export function getRelatedContent(sectionId: string): ContentSection[] {
  const relationships =
    CONTENT_RELATIONSHIPS[sectionId as keyof typeof CONTENT_RELATIONSHIPS] || [];
