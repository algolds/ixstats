  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen p-8">
      <GlassCard variant="diplomatic" blur="prominent" glow="hover" className="max-w-2xl w-full p-12 animate-fade-in">
        <h1 className="text-4xl font-bold text-blue-100 mb-4">Intelligence Feed</h1>
        <p className="text-lg text-blue-200 mb-2">Live intelligence updates and global developments.</p>
