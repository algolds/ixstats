...
export function NotificationsAdmin() {
  ...
  const handleCreateNotification = () => {
    ...
    const notificationData = {
      ...
      userId:
        createFormData.scope === "user" && createFormData.userId
  ...
  const testIntelligenceNotification = async () => {
    try {
      await addNotification({
        ...
        message:
          "This is a test of the intelligence notification system. High-priority security alert detected.",
        category: "security",
        type: "alert",
        priority: "critical",
        severity: "urgent",
        ...
        actions: [
          {
            ...
            type: "primary",
            onClick: () =>
              setTestResults((prev) => [...prev, "Intelligence notification action clicked"]),
          },
        ],
        triggers: [
          {
        ...
        actions: [
          {
            ...
            type: "primary",
            onClick: () =>
              setTestResults((prev) => [...prev, "Economic notification action clicked"]),
          },
        ],
        triggers: [
          {
  ...
  const testDiplomaticNotification = async () => {
    try {
      ...
      setTestResults((prev) => [
        ...prev,
        "✅ Diplomatic notification processed via specialized service",
      ]);
    } catch (error) {
          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-4">
            ...
            <Card>
              <CardContent className="p-4">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-muted-foreground text-sm font-medium">Read</p>
              ...
              <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    onValueChange={(value) =>
                      setCreateFormData((prev) => ({ ...prev, type: value as any }))
                    }
                  >
                    <SelectTrigger>
                      <SelectValue />
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    onValueChange={(value) =>
                      setCreateFormData((prev) => ({ ...prev, level: value as any }))
                    }
                  >
                    <SelectTrigger>
                      <SelectValue />
              ...
              {createFormData.scope === "country" && (
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    onValueChange={(value) =>
                      setCreateFormData((prev) => ({ ...prev, countryId: value }))
                    }
                  >
                    <SelectTrigger>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                <Button
                  ...
                  className="flex h-auto items-center gap-2 border border-red-500/30 bg-red-500/20 p-4 hover:bg-red-500/30"
                >
                ...
                <Button
                  ...
                  className="flex h-auto items-center gap-2 border border-green-500/30 bg-green-500/20 p-4 hover:bg-green-500/30"
                >
                ...
                <Button
                  ...
                  className="flex h-auto items-center gap-2 border border-blue-500/30 bg-blue-500/20 p-4 hover:bg-blue-500/30"
                >
                ...
                <Button
                  ...
                  className="flex h-auto items-center gap-2 border border-yellow-500/30 bg-yellow-500/20 p-4 hover:bg-yellow-500/30"
                >
              ...
              <div className="flex gap-4">
                ...
                <Button onClick={clearTestResults} variant="outline" className="flex-1">
                  Clear Results
                </Button>
              </div>
