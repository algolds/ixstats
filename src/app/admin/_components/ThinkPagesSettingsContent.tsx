  ...
  return (
    <div className="space-y-6">
      ...
      <Tabs defaultValue="platform" className="w-full">
        <TabsList className="glass-surface border-border/40 grid w-full grid-cols-2 max-w-md p-1">
          <TabsTrigger value="platform" className="text-xs md:text-sm">Platform Settings</TabsTrigger>
          <TabsTrigger value="discord" className="text-xs md:text-sm">Discord Mirror Feed</TabsTrigger>
        </TabsList>
            ...
            <div className="flex items-center justify-between gap-4 py-2">
              <div>
                ...
                <p className="text-muted-foreground mt-0.5 text-xs">
                  Likes + reposts + replies. Posts mirror instantly on creation, so leave at 0 unless
                  you switch to polling later.
                </p>
              </div>
              <Input
                type="number"
      ...
      <Card className="glass-surface border-border/40">
        ...
        <CardContent>
          ...
          {previewLoading ? (
            ...
            <p className="text-muted-foreground py-4 text-center text-sm">No recent public posts.</p>
          ) : (
                ...
                <div key={p.id} className="flex items-start gap-3 py-2">
                  ...
                  <div className="min-w-0 flex-1">
                    <div className="flex items-center gap-1.5 text-xs">
                      ...
                      {p.accountType && (
                        <span className="text-muted-foreground/60 capitalize">· {p.accountType}</span>
                      )}
                    </div>
