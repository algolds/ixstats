// src/app/admin/_components/ThinkpagesDiscordFeedContent.tsx
"use client";
...
import { Rss, Save, Send, CheckCircle2, XCircle, Loader2, Hash, Users, ShieldCheck } from "lucide-react";
...
export function ThinkpagesDiscordFeedContent() {
  usePageTitle({ title: "Admin - ThinkPages Discord Feed" });
  ...
  return (
    <div className="space-y-6">
      <AdminHeader
        icon={Rss}
        title="ThinkPages → Discord Feed"
        description="Mirror public ThinkPages feed posts to the #thinkpages Discord channel. Configure exactly which posts get forwarded."
      />
