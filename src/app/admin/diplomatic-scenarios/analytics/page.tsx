...
export default function DiplomaticScenariosAnalyticsPage() {
  ...
  const {
    ...
    error: choiceError,
  } = api.diplomaticScenarios.getChoiceDistribution.useQuery({});
  const {
  ...
  const difficultyData = [
    ...
    { name: "Moderate", value: Math.floor(totalScenarios * 0.4) },
    { name: "Challenging", value: Math.floor(totalScenarios * 0.3) },
    { name: "Critical", value: Math.floor(totalScenarios * 0.1) },
  ...
  const choiceDistributionData = choiceStats.distribution.slice(0, 10).map((choice) => ({
    ...
    <div className="container mx-auto space-y-6 py-8">
      ...
      <div className="space-y-2">
        <h1 className="text-3xl font-bold tracking-tight text-red-600">
          Diplomatic Scenarios Analytics
        </h1>
        <p className="text-muted-foreground">
          Comprehensive usage analytics and statistics for diplomatic scenario generation and player
          choices
        </p>
      </div>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <Card className="border-red-200 bg-gradient-to-br from-red-50 to-white">
          ...
          <CardContent>
            ...
            <p className="text-muted-foreground text-xs">Across all scenario types</p>
          </CardContent>
        </Card>
        ...
        <Card className="border-red-200 bg-gradient-to-br from-red-50 to-white">
          ...
          <CardContent>
            ...
            <p className="text-muted-foreground text-xs">Currently awaiting player decision</p>
          </CardContent>
        </Card>
        ...
        <Card className="border-red-200 bg-gradient-to-br from-red-50 to-white">
          ...
          <CardContent>
            ...
            <p className="text-muted-foreground text-xs">Scenarios generated for players</p>
          </CardContent>
        </Card>
        ...
        <Card className="border-red-200 bg-gradient-to-br from-red-50 to-white">
          ...
          <CardContent>
            ...
            <p className="text-muted-foreground text-xs">Player engagement metric</p>
          </CardContent>
        </Card>
      </div>
          ...
          <CardContent>
            <ChartContainer config={chartConfig} className="h-[300px] w-full">
              <LineChart data={completionTrendData}>
                <CartesianGrid strokeDasharray="3 3" />
                <XAxis dataKey="day" angle={-45} textAnchor="end" height={80} interval={4} />
                <YAxis />
                <ChartTooltip content={<ChartTooltipContent />} />
                <Line
                  type="monotone"
        ...
        <Card className="col-span-2 border-red-200">
          <CardHeader>
            <CardTitle className="text-red-600">
              Choice Distribution (Top 10 Most Popular)
            </CardTitle>
                ...
                <tbody>
                  {deprecationCandidates.map((scenario, index) => (
                    <tr key={scenario.type} className={index % 2 === 0 ? "bg-red-50/50" : ""}>
                      ...
                      <td className="px-4 py-3 text-center font-mono text-sm">{scenario.total}</td>
