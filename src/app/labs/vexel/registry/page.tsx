    ...
    <div className="min-h-screen bg-zinc-950 p-8 text-zinc-100 font-sans">
      <div className="mx-auto max-w-6xl">
        <header className="mb-8 flex items-center justify-between border-b border-white/10 pb-6">
          <div>
            <h1 className="text-3xl font-bold tracking-wider text-amber-500">🛡️ Heraldic Registry</h1>
            <p className="mt-1 text-sm text-zinc-400">Rolls of the public sovereign, institutional, and personal coats of arms</p>
          </div>
