 ...
 * - otherwise -> "Emerging"
 *
 * 💡 KISTAN'S CHEAT NOTES:
 * 1. Ordering Matters: Check the highest threshold first (>= 40000) so larger numbers
 *    don't accidentally get trapped in lower clauses!
 * 2. Return Early: Returning a value stops execution immediately, so you don't need
