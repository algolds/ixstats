    ...
    <div className="relative min-h-screen bg-[#07090e] p-6 text-slate-100 md:p-8">
      ...
      <div className="mx-auto max-w-6xl space-y-6">
        ...
        <div className="flex flex-col justify-between gap-4 border-b border-white/5 pb-5 md:flex-row md:items-center">
          ...
          <div className="flex items-center gap-2 text-xs bg-white/5 border border-white/10 rounded-full px-3 py-1 text-slate-300 self-start md:self-auto">
          ...
          {activeTab === "sim" && (
            <div className="grid gap-6 md:grid-cols-3">
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    <div className="flex justify-between text-sm">
                      <span className="text-slate-300">Income Tax Rate</span>
              ...
              >
                ...
                <div className="mt-6 border-t border-white/5 pt-4 text-left text-xs text-slate-300 space-y-1">
              ...
              {profileLoading ? (
                ...
                <div className="flex items-start gap-3 bg-red-950/30 border border-red-900/50 p-4 rounded-xl text-red-400 text-sm">
                  ...
                  <div>
                    ...
                    <p className="text-red-300 text-xs mt-1">{profileError.message}</p>
                  </div>
                </div>
              ) : (
                <div className="space-y-4">
