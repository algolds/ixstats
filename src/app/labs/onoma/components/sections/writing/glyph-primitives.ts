...
export const STARTER_SCRIPT_PACKS: StarterScriptPack[] = [
  {
    ...
    glyphs: [
      ...
      {
        phoneme: "e",
        svgPath: "M 40 64 L 88 64 C 88 36, 40 36, 40 64 C 40 92, 88 92, 88 80",
        unicode: "E",
      },
      { phoneme: "f", svgPath: "M 80 28 C 50 28, 50 48, 50 96 M 36 56 L 70 56", unicode: "F" },
      {
        phoneme: "g",
        svgPath: "M 88 48 C 88 32, 40 32, 40 64 C 40 96, 88 96, 88 64 L 64 64",
        unicode: "G",
      },
      ...
      { phoneme: "n", svgPath: "M 36 96 L 36 40 L 92 96 L 92 40", unicode: "N" },
      {
        phoneme: "o",
        svgPath:
          "M 64 32 C 84 32, 96 48, 96 68 C 96 88, 84 96, 64 96 C 44 96, 32 88, 32 68 C 32 48, 44 32, 64 32 Z",
        unicode: "O",
      },
      {
        phoneme: "r",
        svgPath: "M 40 96 L 40 32 L 72 32 C 86 32, 86 56, 72 56 L 40 56 M 64 56 L 88 96",
        unicode: "R",
      },
      {
        phoneme: "s",
        svgPath: "M 84 40 C 84 28, 44 28, 44 48 C 44 68, 84 64, 84 84 C 84 100, 40 100, 40 88",
        unicode: "S",
      },
      ...
      {
        phoneme: "sh",
        svgPath: "M 88 36 C 40 36, 40 64, 88 64 C 88 92, 40 92, 40 96 M 64 20 L 64 28",
        unicode: "ʃ",
      },
      {
        phoneme: "th",
        svgPath:
          "M 64 28 C 84 28, 92 46, 92 64 C 92 82, 84 96, 64 96 C 44 96, 36 82, 36 64 C 36 46, 44 28, 64 28 Z M 36 64 L 92 64",
        unicode: "θ",
      },
    ],
  },
  {
    ...
    description:
      "Angular carved strokes designed for wood/stone inscriptions with no horizontal lines.",
    typology: "alphabet",
    direction: "ltr",
    glyphs: [
      ...
      {
        phoneme: "r",
        svgPath: "M 40 24 L 40 96 M 40 28 L 78 44 L 40 60 M 60 52 L 84 96",
        unicode: "ᚱ",
      },
      ...
      {
        phoneme: "b",
        svgPath: "M 40 24 L 40 96 M 40 24 L 76 42 L 40 60 L 76 78 L 40 96",
        unicode: "ᛒ",
      },
      {
        phoneme: "m",
        svgPath:
          "M 36 24 L 36 96 M 92 24 L 92 96 M 36 24 L 64 54 L 92 24 M 36 24 L 92 64 M 92 24 L 36 64",
        unicode: "ᛗ",
      },
    ...
    glyphs: [
      {
        phoneme: "sol",
        svgPath:
          "M 64 36 C 80 36, 92 48, 92 64 C 92 80, 80 92, 64 92 C 48 92, 36 80, 36 64 C 36 48, 48 36, 64 36 Z M 64 20 L 64 30 M 64 98 L 64 108 M 20 64 L 30 64 M 98 64 L 108 64",
        unicode: "☉",
      },
      {
        phoneme: "luna",
        svgPath: "M 74 24 C 42 36, 42 92, 74 104 C 54 90, 54 38, 74 24 Z",
        unicode: "☽",
      },
      {
        phoneme: "ast",
        svgPath: "M 64 20 L 64 108 M 20 64 L 108 64 M 34 34 L 94 94 M 34 94 L 94 34",
        unicode: "✶",
      },
      {
        phoneme: "pyr",
        svgPath: "M 64 24 L 28 92 L 100 92 Z M 64 48 L 48 84 L 80 84 Z",
        unicode: "▲",
      },
      {
        phoneme: "hydr",
        svgPath:
          "M 64 24 C 64 24, 36 60, 36 78 C 36 94, 48 104, 64 104 C 80 104, 92 94, 92 78 C 92 60, 64 24, 64 24 Z",
        unicode: "💧",
      },
      {
        phoneme: "aether",
        svgPath:
          "M 64 24 C 88 44, 88 84, 64 104 C 40 84, 40 44, 64 24 Z M 24 64 C 44 88, 84 88, 104 64 C 84 40, 44 40, 24 64 Z",
        unicode: "✧",
      },
    ],
  },
