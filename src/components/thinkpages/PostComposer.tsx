...
const VISIBILITY_OPTIONS = {
  ...
  private: {
    icon: Lock,
    label: "Private",
    description: "Only you and mentioned users can see this",
  },
  unlisted: {
    icon: AtSign,
    label: "Mentioned only",
    description: "Only mentioned accounts can see this",
  },
};
...
export function PostComposer({
  ...
  return (
    <motion.div
      ...
      className={cn(
        "rounded-lg border border-white/10 bg-white/5 backdrop-blur-sm transition-all",
        compact ? "p-3" : "p-4"
      )}
    >
      {replyTo && (
        <div className="bg-muted/20 border-muted/20 mb-4 rounded-lg border p-3">
          ...
          <div className="text-muted-foreground line-clamp-2 text-sm">{replyTo.content}</div>
        </div>
      )}
        ...
        <div className="flex-1">
          ...
          <div className="relative">
            <Textarea
              ...
              maxLength={maxLength}
              className={cn(
                "placeholder:text-muted-foreground min-h-[60px] resize-none border-0 bg-transparent p-0 text-base focus-visible:ring-0",
          ...
          <AnimatePresence>
            {isExpanded && (
              ...
              >
                  ...
                  <div className="flex items-center gap-2">
                    <div className="relative">
                      <button
                        ...
                        className="bg-muted/20 hover:bg-muted/40 flex items-center gap-1 rounded-full px-3 py-1 text-sm transition-colors"
                      >
                      ...
                      <AnimatePresence>
                        {showVisibilityMenu && (
                          <motion.div
                            ...
                            className="bg-background border-border absolute top-full left-0 z-50 mt-2 w-64 rounded-lg border shadow-lg"
                          >
                    ...
                    <button
                      onClick={() => insertText("#")}
                      className="hover:bg-muted/20 text-muted-foreground rounded-full p-2 transition-colors"
                    >
                    ...
                    <button className="hover:bg-muted/20 text-muted-foreground rounded-full p-2 transition-colors">
                ...
                <div className="text-muted-foreground mt-2 text-xs">Press Ctrl+Enter to post</div>
              </motion.div>
            )}
          </AnimatePresence>
