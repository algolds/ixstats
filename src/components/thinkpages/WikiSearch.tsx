      ...
      <div className="mt-2 max-h-80 overflow-y-auto">
        <div className="grid grid-cols-3 gap-2">
          {isLoading ? (
              ...
              {allImages.map((file: any, index: number) => (
                ...
                >
                  <img
                    ...
                    loading="lazy"
                  />
                  <div className="absolute inset-0 flex items-center justify-center bg-black/50 p-1 text-center text-xs font-medium text-white opacity-0 transition-opacity group-hover:opacity-100">
            ...
            <div className="text-muted-foreground col-span-3 p-6 text-center">
