                          ...
                          <div className="hover:bg-muted/40 hover:border-border/30 mb-2.5 flex items-center gap-3 rounded-xl border border-transparent p-2 transition-all dark:hover:border-white/5 dark:hover:bg-white/5">
                            ...
                            <div className="min-w-0 flex-1">
                              <div className="flex items-center gap-2">
                                <button
                                  onClick={() => onAccountClick?.(reaction.account.id)}
                                  className="text-foreground truncate text-left text-sm font-semibold transition-colors hover:text-violet-500 hover:underline dark:text-white dark:hover:text-violet-400"
                                >
                                  {reaction.account.displayName}
                                </button>
