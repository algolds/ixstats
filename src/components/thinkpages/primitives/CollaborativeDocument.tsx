...
export function CollaborativeDocument({
  ...
  } = api.thinkpages.getThinktankDocuments.useQuery(
    {
      groupId,
    },
    {
  ...
  const { data: currentDocument, refetch: refetchCurrentDocument } =
    api.thinkpages.getThinktankDocument.useQuery(
      {
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-muted-foreground text-sm">{docCount} / 10 documents used</p>
              </div>
            </div>
          ...
          {isLoading ? (
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
              {documents.map((doc) => (
                ...
                >
                  <Card
                    className="glass-hierarchy-interactive cursor-pointer transition-all hover:border-orange-500/50"
        ...
        <Dialog open={showCreateModal} onOpenChange={setShowCreateModal}>
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>Create a Scriptor Doc to work on together.</DialogDescription>
            </DialogHeader>
            ...
            <div className="space-y-4 text-sm">
              <div>
                ...
                <p className="text-muted-foreground">
                  Scriptor is a lore writing and planning space that allows users to create and edit
                  documents while collaborating in real-time. You can share documents with other
                  users and edit them together, import wiki-text, and export as HTML, Markdown,
                  JSON, or PDF.
                </p>
              </div>
              ...
              <div>
                ...
                <ul className="text-muted-foreground list-inside list-disc space-y-1">
                  <li>
                    <strong>Real-time Auto-save:</strong> Your changes are automatically saved every
                    2 seconds
                  </li>
                  <li>
                    <strong>Version Control:</strong> Each save increments the document version
                    number
                  </li>
                  <li>
                    <strong>Rich Text Editing:</strong> Format text, add links, images, and more
                  </li>
                  <li>
                    <strong>Export Options:</strong> Download as HTML, Markdown, JSON, or PDF
                  </li>
                  <li>
                    <strong>Privacy Controls:</strong> Make documents public or keep them
                    members-only
                  </li>
                  <li>
                    <strong>Collaborative Editing:</strong> Multiple users can edit simultaneously
              ...
              <div>
                ...
                <div className="text-muted-foreground grid grid-cols-2 gap-2">
                  <div>
                    <kbd className="bg-muted rounded px-2 py-1 text-xs">Ctrl+S</kbd> Manual Save
                  </div>
                  <div>
                    <kbd className="bg-muted rounded px-2 py-1 text-xs">Ctrl+B</kbd> Bold
                  </div>
                  <div>
                    <kbd className="bg-muted rounded px-2 py-1 text-xs">Ctrl+I</kbd> Italic
                  </div>
                  <div>
                    <kbd className="bg-muted rounded px-2 py-1 text-xs">Ctrl+U</kbd> Underline
                  </div>
                </div>
              </div>
    ...
    <Card className={`glass-hierarchy-child ${className}`}>
      <CardHeader>
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <CardTitle className="text-lg">
                {currentDocument?.title || selectedDocument?.title}
              </CardTitle>
          ...
          <div className="flex items-center gap-2">
            <Button variant="ghost" size="sm" onClick={() => setShowHelpModal(true)} title="Help">
              <HelpCircle className="h-4 w-4" />
            </Button>
      ...
      <CardContent className="p-4">
        {isEditing ? (
          ...
          <div>
            <div
              className="prose prose-sm min-h-[500px] max-w-none"
      ...
      <Dialog open={showExportModal} onOpenChange={setShowExportModal}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>Choose a format to export your document</DialogDescription>
          </DialogHeader>
          <div className="grid grid-cols-2 gap-4">
            ...
            >
              <Code className="mb-2 h-8 w-8 text-orange-500" />
              <span>HTML</span>
              <span className="text-muted-foreground text-xs">Web format</span>
            </Button>
            <Button
              variant="outline"
              className="h-24 flex-col"
            ...
            >
              ...
              <span>Markdown</span>
              <span className="text-muted-foreground text-xs">Plain text</span>
            </Button>
            <Button variant="outline" className="h-24 flex-col" onClick={() => handleExport("pdf")}>
              <FileDown className="mb-2 h-8 w-8 text-red-500" />
              <span>PDF</span>
              <span className="text-muted-foreground text-xs">Print format</span>
            </Button>
            <Button
              variant="outline"
              className="h-24 flex-col"
            ...
            >
              ...
              <span>JSON</span>
              <span className="text-muted-foreground text-xs">Data format</span>
            </Button>
          </div>
        </DialogContent>
      </Dialog>
        ...
        <DialogContent className="max-h-[80vh] max-w-2xl overflow-y-auto">
          ...
          <div className="space-y-4 text-sm">
            <div>
              ...
              <p className="text-muted-foreground">
                Scriptor is a lore writing and planning space that allows users to create and edit
                documents while collaborating in real-time. You can share documents with other users
                and edit them together, import wiki-text, and export as HTML, Markdown, JSON, or
                PDF.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="text-muted-foreground list-inside list-disc space-y-1">
                <li>
                  <strong>Real-time Auto-save:</strong> Your changes are automatically saved every 2
                  seconds
                </li>
                <li>
                  <strong>Version Control:</strong> Each save increments the document version number
                </li>
                <li>
                  <strong>Rich Text Editing:</strong> Format text, add links, images, and more
                </li>
                ...
                <li>
                  <strong>Privacy Controls:</strong> Make documents public or keep them members-only
                </li>
                <li>
                  <strong>Collaborative Editing:</strong> Multiple users can edit simultaneously
                  (with WebSocket support)
