...
export function AccountIndicator({
  ...
  const AccountTypeIcon = ACCOUNT_TYPE_ICONS[account.accountType as keyof typeof ACCOUNT_TYPE_ICONS];
  const accountTypeColor = ACCOUNT_TYPE_COLORS[account.accountType as keyof typeof ACCOUNT_TYPE_COLORS] || 'text-gray-500 bg-gray-500/20 border-gray-500/30';
  const accountTypeLabel = ACCOUNT_TYPE_LABELS[account.accountType as keyof typeof ACCOUNT_TYPE_LABELS] || 'Unknown Account Type';
    ...
    <div className={cn(
      ...
      <div className="relative">
        ...
        {showAccountType && AccountTypeIcon && (
          <div className={cn(
            "absolute -bottom-0.5 -right-0.5 p-0.5 rounded border-2 border-background",
            accountTypeColor
          )}>
      ...
      <div className={cn(
        ...
        <div className="flex items-center gap-1 flex-wrap">
          ...
          {/* Verified Badge */}
          {account.verified && (
            <Verified className={cn(iconSize, "text-blue-500 fill-current flex-shrink-0")} />
          )}
        ...
        {showAccountType && layout === 'vertical' && (
          <div className="flex items-center gap-1 mt-0.5">
            {AccountTypeIcon && <AccountTypeIcon className={cn(iconSize, accountTypeColor.split(' ')[0])} />}
