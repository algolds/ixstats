    ...
    >
      <div className="mb-2 flex items-center justify-between">
        <div className="flex items-center space-x-2">
          <div className={cn("rounded p-1", iconColorClasses[color])}>{icon}</div>
        ...
        <Card className="from-primary/5 to-purple/5 border-primary/20 bg-gradient-to-r">
          ...
          <CardContent className="space-y-3">
            <div className="grid grid-cols-1 gap-4 text-sm md:grid-cols-2">
              <div>
                <h4 className="text-primary mb-2 font-medium">Performance Drivers</h4>
              ...
              <div>
                <h4 className="text-primary mb-2 font-medium">Key Metrics</h4>
                <div className="space-y-2">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span
                      className={`font-medium ${state.conflicts.length > 0 ? "text-red-600" : "text-green-600"}`}
                    >
        ...
        <CardContent>
          <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
            <div className="space-y-2">
              ...
              <p className="text-muted-foreground text-sm">GDP growth impact</p>
            ...
            <div className="space-y-2">
              ...
              <p className="text-muted-foreground text-sm">Cumulative GDP impact</p>
              <div className="text-sm">
            ...
            <div className="space-y-2">
              ...
              <div
                className={cn(
                  "text-2xl font-bold",
                  (economicModifiers.stabilityIndex ?? 50) > 60
                    ? "text-green-600"
                    : (economicModifiers.stabilityIndex ?? 50) < 40
                      ? "text-red-600"
                      : "text-yellow-600"
                )}
              >
              ...
              <p className="text-muted-foreground text-sm">Stability trend</p>
              <div className="text-sm">
