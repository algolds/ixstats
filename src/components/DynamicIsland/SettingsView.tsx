      ...
      {isLoaded && isSignedIn && user ? (
        ...
        <div className="space-y-3">
          ...
          <div className="border-t border-border pt-3">
            <Button
              asChild
              size="sm"
              className="w-full flex items-center gap-2 p-3 bg-red-50 dark:bg-red-950/20 hover:bg-red-100 dark:hover:bg-red-950/30 text-red-600 dark:text-red-400 hover:text-red-700 dark:hover:text-red-300 border-red-200 dark:border-red-800"
            >
              <SignOutButton>
        ...
        <div className="text-center py-6">
          <div className="p-6 bg-muted/50 rounded-xl">
            ...
            <div className="text-lg font-medium mb-2">Welcome to IxStats</div>
            <div className="text-sm text-muted-foreground mb-6">Sign in to access your personalized dashboard and settings</div>
            <Button
              size="lg"
