  ...
  const searchResults: SearchResult[] = useMemo(() => {
    ...
    if (searchFilter === 'all' || searchFilter === 'commands') {
      ...
      if (!user) {
        ...
        contextualCommands.push(
          { name: "Sign Out", path: "/sign-out", icon: LogOut, description: "Sign out of your account" }
        );
      }
      ...
      if (pathname !== '/') {
        contextualCommands.unshift(
          { name: "Home", path: "/", icon: Home, description: "Return to IxStats homepage" }
        );
      }
          ...
          results.push({
            ...
            action: () => {
              ...
              if (feature.path === '#refresh') {
                ...
                const searchInput = document.querySelector('[data-command-palette-search="true"]') as HTMLInputElement;
...
export const commands = [
  // Core pages
  { name: "Dashboard", path: "/dashboard", icon: BarChart3, description: "Main analytics dashboard with economic overview" },
  { name: "Countries", path: "/countries", icon: Globe, description: "Browse and explore all world countries" },
  { name: "Explore Countries", path: "/explore", icon: Globe, description: "Advanced country exploration and discovery" },
  { name: "MyCountry®", path: "/mycountry", icon: Crown, description: "Your national dashboard and executive command center" },
  { name: "MyCountry Editor", path: "/mycountry/editor", icon: Crown, description: "Edit and customize your country profile" },

  // Intelligence & Strategic Systems
  { name: "ECI Suite", path: "/eci", icon: Gauge, description: "Economic Command Interface and strategic tools" },
  { name: "ECI Focus", path: "/eci/focus", icon: Target, description: "Focused ECI analysis and planning" },
  { name: "SDI Intelligence", path: "/sdi", icon: Eye, description: "Strategic Defense Initiative and intelligence reports" },
  { name: "SDI Diplomatic", path: "/sdi/diplomatic", icon: Eye, description: "Diplomatic intelligence and relations" },

  // Knowledge & Communication
  { name: "ThinkPages", path: "/thinkpages", icon: TrendingUp, description: "Knowledge management and collaborative thinking" },
  { name: "IxWiki", path: "/wiki", icon: Activity, description: "Access the IxWiki knowledge base" },

  // Tools & Creation
  { name: "Country Builder", path: "/builder", icon: Plus, description: "Create and design your own country" },
  { name: "Import Tool", path: "/builder/import", icon: Plus, description: "Import country data from external sources" },
  { name: "Trading Cards", path: "/cards", icon: Activity, description: "Collect and trade country cards" },

  // User & Admin
  { name: "Profile Settings", path: "/profile", icon: Settings, description: "Manage your account and preferences" },
  { name: "Setup Wizard", path: "/setup", icon: Target, description: "Complete initial account and country setup" },
  { name: "Admin Panel", path: "/admin", icon: Settings, description: "Administrative tools and controls" },
  { name: "DM Dashboard", path: "/dm-dashboard", icon: Settings, description: "Dungeon Master administrative dashboard" },

  // Labs & Generators
  { name: "Vexel Lab", path: "/labs/vexel", icon: Target, description: "Heraldry and coat of arms generator" },
  { name: "Onoma Lab", path: "/labs/onoma", icon: Activity, description: "Markov-based name generator" },
  { name: "Strata Lab", path: "/labs/strata", icon: Plus, description: "City and roadmap generator" },
  { name: "Dynas Lab", path: "/labs/dynas", icon: Crown, description: "Family and dynasty generator" },
  { name: "Nomora Lab", path: "/labs/nomora", icon: Globe, description: "Constructed language generator" },
];

export const features = [
  // Dashboard & Analytics
  { name: "Economic Analysis", path: "/dashboard", icon: BarChart3, description: "Detailed economic metrics, GDP, and financial projections" },
  { name: "Population Analytics", path: "/dashboard", icon: Activity, description: "Demographics, population trends, and social statistics" },
  { name: "Global Rankings", path: "/countries", icon: Crown, description: "Compare countries by economic tier and performance" },
  { name: "Economic Modeling", path: "/dashboard", icon: BarChart3, description: "Advanced economic forecasting and scenario modeling" },

  // MyCountry Intelligence System
  { name: "Executive Dashboard", path: "/mycountry", icon: Crown, description: "National command center with real-time intelligence" },
  { name: "Country Profile Editor", path: "/mycountry/editor", icon: Crown, description: "Customize your nation's profile and settings" },
  { name: "Economic Overview", path: "/mycountry", icon: TrendingUp, description: "Your country's economic performance and growth" },
  { name: "National Intelligence", path: "/mycountry", icon: Eye, description: "Comprehensive national intelligence briefings" },

  // Strategic Systems
  { name: "Strategic Planning", path: "/eci", icon: Gauge, description: "Long-term strategic planning and policy tools" },
  { name: "Focus Areas", path: "/eci/focus", icon: Target, description: "Strategic focus management and priority setting" },
  { name: "Intelligence Reports", path: "/sdi", icon: Eye, description: "Strategic defense and intelligence analysis" },
  { name: "Diplomatic Relations", path: "/sdi/diplomatic", icon: Eye, description: "International diplomatic intelligence and analysis" },

  // Country Discovery & Analysis
  { name: "Country Exploration", path: "/countries", icon: Globe, description: "Discover and analyze countries worldwide" },
  { name: "Advanced Search", path: "/explore", icon: Globe, description: "Advanced country search with filtering and comparison" },
  { name: "Country Profiles", path: "/countries", icon: Globe, description: "Detailed individual country analysis and data" },
  { name: "Economic Comparison", path: "/countries", icon: BarChart3, description: "Compare economic metrics across nations" },

  // Knowledge & Documentation
  { name: "Knowledge Management", path: "/thinkpages", icon: TrendingUp, description: "Collaborative wiki and documentation system" },
  { name: "Wiki Integration", path: "/wiki", icon: Activity, description: "Access integrated IxWiki knowledge base" },
  { name: "Documentation", path: "/thinkpages", icon: Activity, description: "Platform documentation and guides" },

  // Content Creation & Tools
  { name: "Country Creation", path: "/builder", icon: Plus, description: "Build and design custom countries from scratch" },
  { name: "Data Import", path: "/builder/import", icon: Plus, description: "Import country data from external wiki sources" },
  { name: "Trading Cards", path: "/cards", icon: Activity, description: "Country trading card collection and management" },

  // Creative Labs & Generators
  { name: "Heraldry Design", path: "/labs/vexel", icon: Target, description: "Create custom coats of arms and flags" },
  { name: "Name Generation", path: "/labs/onoma", icon: Activity, description: "Generate names using Markov chains" },
  { name: "City Planning", path: "/labs/strata", icon: Plus, description: "Design cities and infrastructure layouts" },
  { name: "Dynasty Building", path: "/labs/dynas", icon: Crown, description: "Create family trees and royal lineages" },
  { name: "Language Creation", path: "/labs/nomora", icon: Globe, description: "Construct artificial languages and linguistics" },

  // Administrative & System Tools
  { name: "Account Setup", path: "/setup", icon: Target, description: "Initial account configuration and country linking" },
  { name: "Profile Management", path: "/profile", icon: Settings, description: "Personal account settings and preferences" },
  { name: "System Administration", path: "/admin", icon: Settings, description: "Platform administration and management tools" },
  { name: "DM Tools", path: "/dm-dashboard", icon: Settings, description: "Dungeon Master tools and administrative controls" },
  { name: "IxTime System", path: "/admin", icon: Settings, description: "Time synchronization and temporal management" },
  { name: "User Management", path: "/admin", icon: Settings, description: "User administration and role management" },
  { name: "Data Export", path: "/dashboard", icon: TrendingUp, description: "Export economic data and statistical reports" },

  // Quick Actions & Utilities
  { name: "Refresh Data", path: "#refresh", icon: Activity, description: "Refresh current page data and statistics" },
  { name: "Global Search", path: "#search", icon: Activity, description: "Search across all countries, features, and content" },
  { name: "Notifications", path: "#notifications", icon: Activity, description: "View system notifications and alerts" },
];
