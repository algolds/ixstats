  ...
  const quickActions = [
    {
      label: "Meetings",
      icon: Calendar,
      colors: "border-purple-500/20 bg-gradient-to-r from-purple-500/5 to-indigo-500/5 text-purple-400 hover:from-purple-500/15 hover:to-indigo-500/15",
      action: () => navigateToSection("executive"),
    },
    {
      label: "Embassies",
      icon: Globe,
      colors: "border-teal-500/20 bg-gradient-to-r from-teal-500/5 to-emerald-500/5 text-teal-400 hover:from-teal-500/15 hover:to-emerald-500/15",
      action: () => navigateToSection("diplomacy"),
    },
    {
      label: "Foreign Policy",
      icon: Globe,
      colors: "border-cyan-500/20 bg-gradient-to-r from-cyan-500/5 to-blue-500/5 text-cyan-400 hover:from-cyan-500/15 hover:to-blue-500/15",
      action: () => navigateToSection("diplomacy"),
    },
    {
      label: "Domestic Policy",
      icon: Gavel,
      colors: "border-orange-500/20 bg-gradient-to-r from-orange-500/5 to-amber-500/5 text-orange-400 hover:from-orange-500/15 hover:to-amber-500/15",
      action: () => navigateToSection("executive"),
    },
    {
      label: "Operations",
      icon: Shield,
      colors: "border-red-500/20 bg-gradient-to-r from-red-500/5 to-rose-500/5 text-red-400 hover:from-red-500/15 hover:to-rose-500/15",
        ...
        {quickActions.map((item, idx) => {
          ...
          return (
            ...
            >
              ...
              {item.isPremium && (
                <span className="flex items-center gap-1 rounded bg-amber-500/10 px-1.5 py-0.5 text-[9px] font-bold tracking-wider text-amber-500 uppercase border border-amber-500/20 shadow-[0_0_8px_rgba(245,158,11,0.05)] shrink-0">
