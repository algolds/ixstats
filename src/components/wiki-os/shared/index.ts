// src/components/wiki-os/shared/index.ts
// Barrel file for WikiOS shared layout components

export { WikiOSLayout } from "./WikiOSLayout";
...
export { WikiOSLogo } from "./WikiOSLogo";
...
export { IxWikiLogo } from "./IxWikiLogo";
export { IxWikiWordmark } from "./IxWikiWordmark";
