...
export const ATOMIC_TAX_COMPONENTS: Record<string, AtomicTaxComponent> = {
  ...
  digital_filing: {
    ...
    description: 'Online platform for electronic tax filing, reducing paperwork and processing time',
    implementationCost: 150000,
    maintenanceCost: 50000,
    effectiveness: 85,
    prerequisites: [],
    synergies: ['e_filing_infrastructure', 'taxpayer_portal', 'automated_verification', 'integrated_systems'],
    conflicts: [],
  ...
  withholding_system: {
    ...
    category: 'Collection Methods',
    description: 'Employers withhold taxes at source, ensuring steady revenue flow and reducing evasion',
  ...
  real_time_reporting: {
    ...
    synergies: ['withholding_system', 'blockchain_ledger', 'integrated_systems', 'advanced_analytics'],
    conflicts: [],
  ...
  automated_verification: {
    ...
    effectiveness: 87,
    prerequisites: ['digital_filing'],
    synergies: ['risk_based_auditing', 'advanced_analytics', 'blockchain_ledger', 'real_time_reporting'],
    conflicts: [],
  ...
  advanced_analytics: {
    ...
    synergies: ['risk_based_auditing', 'automated_verification', 'integrated_systems', 'blockchain_ledger'],
    conflicts: [],
  ...
  integrated_systems: {
    ...
    synergies: ['third_party_reporting', 'real_time_reporting', 'automated_verification', 'advanced_analytics'],
    conflicts: [],
