    ...
    <div className={`space-y-6 ${className}`}>
      ...
      <Card>
        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-2 text-center">
            <div
              className={`text-4xl font-bold ${getEffectivenessColor(effectiveness.effectivenessScore)}`}
            >
          ...
          <div className="grid grid-cols-3 gap-4">
            <div className="space-y-2 text-center">
              ...
              <Progress value={effectiveness.collectionEfficiency} className="h-2" />
            </div>
            ...
            <div className="space-y-2 text-center">
              ...
              <Progress value={effectiveness.complianceRate} className="h-2" />
            </div>
            ...
            <div className="space-y-2 text-center">
              ...
              <Progress value={effectiveness.auditCapacity} className="h-2" />
            </div>
          </div>
              ...
              {effectiveness.modifierBreakdown.map((breakdown, index) => (
                <div key={index} className="border-l-4 border-blue-200 pl-4">
                  ...
                  <div className="flex gap-4 text-xs">
                    <span>
                      Collection: {Math.round((breakdown.modifiers.collectionEfficiency - 1) * 100)}
                      %
                    </span>
                    <span>
                      Compliance: {Math.round((breakdown.modifiers.complianceRate - 1) * 100)}%
                    </span>
      ...
      {components.length === 0 && (
        <Alert>
          <AlertTriangle className="h-4 w-4" />
          <AlertDescription>
            No atomic government components selected. Tax effectiveness will use baseline values
            only. Add government components to see how they influence tax collection and compliance.
          </AlertDescription>
        </Alert>
      )}
    </div>
