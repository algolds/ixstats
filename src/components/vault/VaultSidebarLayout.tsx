        ...
        <div className="flex gap-4 sm:gap-6">
          ...
          <div className="min-w-0 flex-1">
            ...
            <div className="mb-4 lg:hidden">
              <div className="glass-hierarchy-child scrollbar-none overflow-x-auto rounded-xl border border-border bg-background/60 p-1.5 backdrop-blur-md dark:bg-black/30">
                    ...
                    return (
                      <Link
                        ...
                        className={cn(
                          ...
                          isActive
                            ? "border-purple-500/30 bg-gradient-to-r from-purple-500/20 to-pink-500/20 text-purple-600 dark:text-purple-400 shadow-sm"
