  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex h-full flex-col justify-between">
        ...
        <div className="mt-5">
          <div className="flex items-center gap-2 text-4xl font-bold tracking-tight text-amber-500 sm:text-5xl dark:text-amber-400">
        ...
        <div className="border-border/40 mt-6 grid grid-cols-2 gap-4 border-t pt-4 text-xs">
          ...
          <div>
            ...
            <div className="mt-1 flex items-center gap-1 text-lg font-bold text-indigo-600 dark:text-indigo-400">
              <IxCreditsSymbol className="h-4.5 w-4.5 shrink-0 text-indigo-600 dark:text-indigo-400" />
