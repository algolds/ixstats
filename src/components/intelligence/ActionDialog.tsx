    ...
    try {
      ...
      const priority =
        recommendation.urgency === "urgent"
          ? "critical"
          : recommendation.urgency === "important"
            ? "high"
            : "medium";
                      ...
                      <div className="space-y-2">
                        {recommendation.impact.economic && (
                          <div className="bg-muted/30 flex items-center justify-between rounded p-2">
                            ...
                            <Badge
                              variant={
                                recommendation.impact.economic > 0 ? "default" : "destructive"
                              }
                            >
                              {recommendation.impact.economic > 0 ? "+" : ""}
                              {recommendation.impact.economic}%
                            </Badge>
                          </div>
                        )}
                        {recommendation.impact.social && (
                          <div className="bg-muted/30 flex items-center justify-between rounded p-2">
                            ...
                            <Badge
                              variant={recommendation.impact.social > 0 ? "default" : "destructive"}
                            >
                              {recommendation.impact.social > 0 ? "+" : ""}
                              {recommendation.impact.social}%
                            </Badge>
                          </div>
                        )}
                        {recommendation.impact.diplomatic && (
                          <div className="bg-muted/30 flex items-center justify-between rounded p-2">
                            ...
                            <Badge
                              variant={
                                recommendation.impact.diplomatic > 0 ? "default" : "destructive"
                              }
                            >
                              {recommendation.impact.diplomatic > 0 ? "+" : ""}
                              {recommendation.impact.diplomatic}%
                            </Badge>
                          </div>
                        )}
