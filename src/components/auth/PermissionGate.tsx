...
import { useHasPermission, useHasAnyPermission, useHasAllPermissions, useHasRoleLevel } from '~/hooks/usePermissions';
...
export function PermissionGate({ permission, children, fallback = null }: SinglePermissionGateProps) {
...
export function UnauthorizedMessage({ message = "You don't have permission to access this feature." }: { message?: string }) {
  return (
