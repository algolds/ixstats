...
export function LeagueSettingsModal({
  ...
  }, [open, league.name, league.logo, league.coverImage]);
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>Edit name and branding for this league.</DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-5">
          ...
          <div className="space-y-2">
            ...
            <p className="text-muted-foreground text-[10px] leading-tight">
              Shown on the Apple Card carousel. Recommended 3:2 ratio.
            </p>
            <div className="flex items-start gap-4">
              <div
                className={cn(
