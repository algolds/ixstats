...
export const MapLoadingState = React.memo(function MapLoadingState({ show }: MapLoadingStateProps) {
  if (!show) return null;

  return (
    <div className="absolute inset-0 z-[10000] flex h-full w-full items-center justify-center bg-gray-100/80 backdrop-blur-sm">
