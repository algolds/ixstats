      ...
      <div className="flex flex-col">
        {layers.map((layer) => {
          ...
          return (
            <div key={layer.id}>
              <div
                className={`group flex h-7 items-center gap-1 border-b border-neutral-100 px-1 hover:bg-neutral-100 dark:border-neutral-800 dark:hover:bg-neutral-800/60 ${
              ...
              >
                ...
                {layer.id !== "country-border" ? (
                  ...
                  >
                    {layer.locked ? (
                      ...
                      <Unlock className="h-3 w-3 text-neutral-400 opacity-0 group-hover:opacity-100 dark:text-neutral-500" />
                    )}
                  </button>
                ) : (
                ...
                {/* Layer name */}
                <span className="flex-1 truncate text-[11px] leading-none">{layer.name}</span>

                {/* Feature count badge */}
                {count !== undefined && count > 0 && !layer.isBaseLayer && (
                  <span className="rounded bg-neutral-200 px-1 py-0.5 text-[9px] leading-none font-medium text-neutral-500 dark:bg-neutral-700 dark:text-neutral-400">
                    {count}
                  </span>
                )}
                ...
                {showOpacity && (
                  <button
                    ...
                    className="flex h-5 w-5 shrink-0 items-center justify-center rounded text-[9px] text-neutral-500 hover:bg-neutral-200 hover:text-neutral-700 dark:hover:bg-neutral-700 dark:hover:text-neutral-300"
              ...
              {showOpacity && isExpanded && (
                <div className="flex items-center gap-2 border-b border-neutral-100 bg-neutral-50 px-3 py-1.5 dark:border-neutral-800 dark:bg-neutral-800/50">
