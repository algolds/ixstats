      ...
      >
        ...
        <div className="relative border-b border-slate-100 px-5 py-4 dark:border-white/5">
          <div className="flex items-start justify-between">
            <div className="flex items-center gap-3">
              {isCountryLoading || isStatsLoading ? (
                ...
                <img
                  ...
                  className="h-5 w-8 rounded border border-slate-200 object-cover shadow-md dark:border-white/10"
                />
              ) : (
                <div className="h-5 w-8 rounded border border-slate-200 bg-slate-100 dark:border-white/10 dark:bg-slate-800" />
              )}
              <div>
            ...
            <button
              onClick={exitTour}
              className="rounded-full bg-slate-100 p-1 text-slate-500 transition-colors hover:bg-slate-200 hover:text-slate-800 dark:bg-white/5 dark:text-slate-400 dark:hover:bg-white/10 dark:hover:text-white"
            >
        ...
        <div className="relative space-y-4 px-5 py-4">
          ...
          <div className="grid grid-cols-3 gap-2 border-t border-slate-100 pt-3 dark:border-white/5">
            <div className="space-y-0.5 rounded-lg border border-slate-100 bg-slate-50/50 p-2 text-center dark:border-white/5 dark:bg-white/5">
              <span className="flex items-center justify-center gap-1 text-[9px] tracking-wider text-slate-500 uppercase dark:text-slate-400">
        ...
        <div className="relative flex items-center justify-between border-t border-slate-100 bg-slate-50/50 px-5 py-3.5 dark:border-white/5 dark:bg-slate-900/40">
