...
export const CountryFocusCard = React.memo<CountryFocusCardProps>(
  ({ country, index, hovered, setHovered, expanded, setExpanded, onCountryClick }) => {
        ...
        >
          ...
          <AnimatePresence>
            {isExpanded && (
              ...
              >
                <div className="glass-overlay glass-refraction relative overflow-hidden border-t border-white/20">
                  <AnimatePresence>
                    {isExpanded && (
                      <Spotlight
                  ...
                  <div className="relative z-10 space-y-6 p-6">
                    ...
                    <FadeIn direction="up" delay={0.1}>
                      <TextReveal className="mb-4 text-lg font-semibold text-white/95 antialiased [text-shadow:0_0_10px_rgba(255,255,255,0.3)]">
                        Executive Dashboard
                      </TextReveal>
                    </FadeIn>
                    ...
                    <div className="grid grid-cols-3 gap-4">
                      <FadeIn direction="up" delay={0.2} className="text-center">
                        ...
                        <div className="mt-2 text-xs font-medium text-white/90 antialiased [text-shadow:0_0_8px_rgba(0,0,0,0.8)]">
                          Economic Health
                        </div>
                        <div className="text-xs text-white/70 antialiased [text-shadow:0_0_8px_rgba(0,0,0,0.8)]">
                          <NumberFlowDisplay
                            value={economicScore}
                            format="percentage"
                            decimalPlaces={0}
                    ...
                    <div className="grid grid-cols-2 gap-6">
                      <FadeIn direction="left" delay={0.5} className="space-y-4">
                        <div className="flex items-center gap-2 text-white/95">
                          ...
                          <span className="text-sm font-semibold antialiased [text-shadow:0_0_8px_rgba(0,0,0,0.8)]">
                            Geography
                          </span>
                        </div>
                        <div className="space-y-3 pl-2">
                          {country.landArea && (
                            <div className="flex justify-between text-sm text-white/85">
                              <span className="antialiased [text-shadow:0_0_8px_rgba(0,0,0,0.8)]">
                                Land Area
                              </span>
                              <span className="font-medium antialiased [text-shadow:0_0_8px_rgba(0,0,0,0.8)]">
                                <NumberFlowDisplay
                        ...
                        <div className="space-y-3 pl-2">
                          ...
                          <div className="flex justify-between text-sm text-white/85">
                            ...
                            <span className="flex items-center gap-1">
                              ...
                              <span className="font-medium text-amber-400 antialiased [text-shadow:0_0_8px_rgba(0,0,0,0.8)]">
                                Elite Tier
                              </span>
                            </span>
                          </div>
                    ...
                    {/* Action Bar */}
                    <FadeIn direction="up" delay={0.7} className="border-t border-white/10 pt-4">
                      <div className="flex gap-3">
                        <motion.button
                          onClick={handleCountryVisit}
                          className="glass-floating glass-interactive flex flex-1 items-center justify-center gap-2 rounded-lg bg-blue-500/20 px-4 py-3 font-medium text-white antialiased [text-shadow:0_0_8px_rgba(0,0,0,0.8)] hover:bg-blue-500/30"
                        ...
                        <motion.button
                          className="glass-surface glass-interactive flex items-center justify-center gap-2 rounded-lg bg-white/10 px-4 py-3 text-white transition-colors hover:bg-white/20"
