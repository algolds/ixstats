...
export function NationalSecurityModal({
  ...
  const handleSubmitThreat = (e: React.FormEvent) => {
    ...
    if (
      !newThreatForm.title.trim() ||
      !newThreatForm.category ||
      !newThreatForm.description.trim()
    ) {
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      >
        <DialogHeader>
          ...
          <DialogDescription>
            Monitor threats, assess security status, and manage emergency protocols for national
            security.
          </DialogDescription>
        </DialogHeader>
                ...
                <>
                  ...
                  <GlassCard variant="security">
                    <div className="p-6 pb-4">
                      ...
                      <p className="text-muted-foreground mt-1 text-sm">
                        Real-time national security assessment
                      </p>
                    </div>
                    <div className="p-6">
                      <div className="text-center">
                        <div
                          className={`mb-2 text-4xl font-bold ${getThreatLevelColor(securityDashboard?.threatLevel || "low")}`}
                        >
                  ...
                  <GlassCard variant="security">
                    <div className="p-6 pb-4">
                      ...
                      <p className="text-muted-foreground mt-1 text-sm">
                        Latest reported threats and incidents
                      </p>
                    </div>
                    <div className="p-6">
                            ...
                            >
                              <div className="mb-2 flex items-start justify-between">
                                ...
                                <div className="flex gap-2">
                                  ...
                                  <Badge
                                    variant="outline"
                                    className={getStatusConfig(threat.status)?.bg ?? ""}
                                  >
                              ...
                              <div className="text-muted-foreground flex gap-4 text-xs">
                                <span>
                                  Category:{" "}
                                  {
                                    THREAT_CATEGORIES.find((c) => c.value === threat.category)
                                      ?.label
                                  }
                                </span>
                                <span>
                                  Detected: {new Date(threat.detectedDate).toLocaleDateString()}
                                </span>
                              </div>
                            </div>
                          ))}
                  ...
                  <div className="grid grid-cols-2 gap-4 md:grid-cols-3">
                    {THREAT_CATEGORIES.map((category) => {
                      ...
                      const categoryThreats = activeThreats.filter(
                        ...
                        <GlassCard key={category.value} variant="security">
                          <div className="p-4">
                            <div className="mb-2 flex items-center gap-3">
                              <div className={`rounded-lg p-2 ${category.bg}`}>
                            ...
                            <Progress
                              value={
                                categoryThreats.length > 0
                                  ? Math.min(100, (categoryThreats.length / 5) * 100)
                                  : 0
                              }
                              className="h-2"
                            />
                          ...
                          <form onSubmit={handleSubmitThreat} className="space-y-4">
                            <div>
                              ...
                              <Input
                                ...
                                onChange={(e) =>
                                  setNewThreatForm((prev) => ({ ...prev, title: e.target.value }))
                                }
                                required
                              />
                            </div>
                            <div className="grid grid-cols-2 gap-4">
                              <div>
                                ...
                                <Select
                                  ...
                                  onValueChange={(value) =>
                                    setNewThreatForm((prev) => ({ ...prev, category: value }))
                                  }
                                >
                                  <SelectTrigger>
              ...
              {threatsLoading ? (
                  ...
                  {filteredThreats.map((threat: any) => (
                    ...
                    >
                      <div className="p-4">
                        ...
                        <p className="mb-3 text-sm">{threat.description}</p>
                ...
                <GlassCard variant="security">
                  <div className="p-8 text-center">
                    ...
                    <p className="text-muted-foreground text-sm">
                      Adjust your filters or report a new threat
                    </p>
                  </div>
                </GlassCard>
              )}
          ...
          <TabsContent value="protocols" className="mt-6">
            <GlassCard variant="security">
              <div className="p-6 pb-4">
                ...
                <p className="text-muted-foreground mt-1 text-sm">
                  Standard operating procedures for security incidents
                </p>
              </div>
              <div className="p-6">
          ...
          <TabsContent value="analytics" className="mt-6">
            <GlassCard variant="security">
              <div className="p-6 pb-4">
                ...
                <p className="text-muted-foreground mt-1 text-sm">
                  Trends, patterns, and insights from security data
                </p>
              </div>
              <div className="p-6">
                <Alert>
                  ...
                  <AlertDescription>
                    Advanced security analytics dashboard is being developed. This will include
                    threat trend analysis, predictive modeling, and comprehensive reporting
                    capabilities.
                  </AlertDescription>
                </Alert>
              </div>
