...
export function AIAdvisorModal({ isOpen, onClose, countryId, countryName }: AIAdvisorModalProps) {
  ...
  const generateInitialRecommendations = (): AIRecommendation[] => {
    ...
    if (countryData.adjustedGdpGrowth < 0.02) {
      recommendations.push({
        ...
        description:
          "GDP growth is below optimal levels. Consider investment incentives and infrastructure development.",
        ...
        reasoning:
          "Low GDP growth indicates underutilized economic potential. Strategic investments can stimulate economic activity and create sustainable growth.",
      });
    }
    ...
    if (countryData.populationGrowthRate < 0.01) {
      recommendations.push({
        ...
        description:
          "Population growth is declining. Consider policies to support demographic sustainability.",
        ...
        reasoning:
          "Declining population growth can lead to labor shortages and economic stagnation. Proactive policies can help maintain demographic balance.",
      });
    }
    ...
    if (advancedAnalytics?.volatility?.gdp && advancedAnalytics.volatility.gdp > 0.2) {
      recommendations.push({
        ...
        reasoning:
          "High volatility creates uncertainty for businesses and investors. Stabilization measures can improve economic predictability and growth.",
      });
    }
  ...
  const generateAIResponse = (
    userInput: string
  ): { content: string; recommendations?: AIRecommendation[] } => {
        ...
        recommendations: [
          {
            ...
            description:
              "Comprehensive approach to boost GDP growth through strategic investments.",
            impact: { economic: 8, governance: 6 },
            confidence: 0.88,
            timeframe: "medium_term",
            actions: [
            ...
            reasoning:
              "Strategic investments in key sectors can create multiplier effects and sustainable economic growth.",
          },
        ],
      };
    }
    ...
    if (input.includes("population") || input.includes("demographic")) {
      ...
      const content = `Your population growth rate is ${(popGrowth * 100).toFixed(1)}%. ${
        popGrowth > 0.015
          ? "This indicates healthy population dynamics."
          : popGrowth > 0.005
        ...
        recommendations: [
          {
            ...
            reasoning:
              "Sustainable population policies ensure long-term economic and social stability.",
          },
        ],
      };
    }
    ...
    if (input.includes("risk") || input.includes("volatility") || input.includes("danger")) {
      ...
      const content = `Based on my analysis, your economic volatility is ${(volatility * 100).toFixed(1)}%. ${
        volatility < 0.1
          ? "This indicates stable economic conditions."
          : volatility < 0.2
        ...
        recommendations: [
          {
            ...
            reasoning:
              "Proactive risk management can prevent economic crises and maintain stability.",
          },
        ],
      };
    }
    ...
    return {
      content:
        ...
        userInput +
        ". Let me analyze your country's data and provide specific recommendations. Could you please provide more details about what aspect you'd like me to focus on?",
    };
  };
                          ...
                          {message.recommendations && message.recommendations.length > 0 && (
                            <div className="mt-2 space-y-2">
                              {message.recommendations.map((rec) => (
                                <div
                                  key={rec.id}
                                  className="cursor-pointer rounded border p-2 hover:bg-gray-50 dark:hover:bg-gray-800"
              ...
              {generateInitialRecommendations().map((recommendation) => (
                ...
                >
                  <div className="p-4">
                    ...
                    <h4 className="mb-1 font-semibold">{recommendation.title}</h4>
                ...
                <div className="space-y-4">
                  <div className="rounded-lg border border-blue-500/20 bg-blue-500/10 p-4">
                    ...
                    <p className="text-muted-foreground text-sm">
                      Your GDP growth rate of {(countryData?.adjustedGdpGrowth || 0) * 100}%
                      indicates
                      {countryData?.adjustedGdpGrowth && countryData.adjustedGdpGrowth > 0.03
                        ? " strong economic performance."
                        : countryData?.adjustedGdpGrowth && countryData.adjustedGdpGrowth > 0.01
                          ? " moderate growth with room for improvement."
                  ...
                  <div className="rounded-lg border border-green-500/20 bg-green-500/10 p-4">
                    ...
                    <p className="text-muted-foreground text-sm">
                      Population growth rate of {(countryData?.populationGrowthRate || 0) * 100}%
                      suggests
                      {countryData?.populationGrowthRate && countryData.populationGrowthRate > 0.015
                        ? " healthy demographic dynamics."
                        : countryData?.populationGrowthRate &&
                            countryData.populationGrowthRate > 0.005
                  ...
                  {advancedAnalytics?.volatility && (
                    <div className="rounded-lg border border-orange-500/20 bg-orange-500/10 p-4">
                      ...
                      <p className="text-muted-foreground text-sm">
                        Economic volatility analysis shows{" "}
                        {advancedAnalytics.volatility.gdp && advancedAnalytics.volatility.gdp > 0.2
                          ? "high volatility requiring stabilization measures."
                          : advancedAnalytics.volatility.gdp &&
                              advancedAnalytics.volatility.gdp > 0.1
            ...
            <DialogContent className="max-w-2xl">
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <h4 className="mb-2 font-medium">Impact</h4>
                    <Badge
                      variant="outline"
                  ...
                  <div>
                    <h4 className="mb-2 font-medium">Confidence</h4>
                    <p className="text-sm">
