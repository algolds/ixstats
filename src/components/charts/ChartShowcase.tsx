    ...
    <div className={cn("space-y-8", className)}>
      ...
      >
        ...
        <p className="mx-auto max-w-2xl text-[var(--color-text-secondary)]">
          Comprehensive data visualization library with glass physics integration, interactive
          controls, and multiple chart library support.
        </p>
      </motion.div>
        ...
        <GlassCardHeader>
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <h3 className="font-semibold text-[var(--color-text-primary)]">Global Settings</h3>
            </div>
            <GlassToggle
      ...
      <GlassCard depth="base">
        <GlassCardHeader>
          <h3 className="font-semibold text-[var(--color-text-primary)]">Component Performance</h3>
        </GlassCardHeader>
        <GlassCardContent>
          <div className="grid grid-cols-1 gap-4 text-center md:grid-cols-3">
            <div>
              ...
              <div className="text-sm text-[var(--color-text-muted)]">Active Charts</div>
            </div>
            <div>
              <div className="text-2xl font-bold text-[var(--color-brand-primary)]">
                {themes.length}
              </div>
              <div className="text-sm text-[var(--color-text-muted)]">Available Themes</div>
            </div>
            <div>
              <div className="text-2xl font-bold text-[var(--color-warning)]">
                {showControls ? "4" : "0"}
              </div>
              <div className="text-sm text-[var(--color-text-muted)]">Interactive Controls</div>
            </div>
          </div>
        </GlassCardContent>
      </GlassCard>
