              ...
              <div className="glass-hierarchy-child rounded-lg p-4">
                ...
                <div className="flex flex-col gap-3">
                  <div className="flex items-center gap-3">
                    ...
                    />
                    <div>
                      <p className="text-foreground font-bold">{hostCountry.name}</p>
                      <p className="text-muted-foreground text-xs">Host Country</p>
                    </div>
                  </div>
                  {selectedCountry && (
                    <div className="flex items-center gap-3">
                      ...
                      />
                      <div>
                        <p className="text-foreground font-bold">{selectedCountry.name}</p>
                        <p className="text-muted-foreground text-xs">Participant Country</p>
                      </div>
                    </div>
                  )}
                </div>
              ...
              <div className="glass-hierarchy-child rounded-lg p-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-foreground text-sm font-medium">{maxParticipants}</p>
                  </div>
                  <div>
