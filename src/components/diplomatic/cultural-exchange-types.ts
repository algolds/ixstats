...
export type ExchangeType = 'festival' | 'exhibition' | 'education' | 'cuisine' | 'arts' | 'sports' | 'technology' | 'diplomacy' | 'music' | 'film' | 'environmental' | 'science' | 'trade' | 'humanitarian' | 'agriculture' | 'heritage' | 'youth';
...
export const EXCHANGE_TYPES = {
  festival: {
    ...
    bgColor: 'bg-gradient-to-br from-purple-400/40 to-pink-500/40 dark:from-purple-500/20 dark:to-pink-500/20',
  ...
  exhibition: {
    ...
    bgColor: 'bg-gradient-to-br from-blue-400/40 to-indigo-500/40 dark:from-blue-500/20 dark:to-indigo-500/20',
  ...
  education: {
    ...
    bgColor: 'bg-gradient-to-br from-green-400/40 to-emerald-500/40 dark:from-green-500/20 dark:to-emerald-500/20',
  ...
  cuisine: {
    ...
    bgColor: 'bg-gradient-to-br from-orange-400/40 to-red-500/40 dark:from-orange-500/20 dark:to-red-500/20',
  ...
  arts: {
    ...
    bgColor: 'bg-gradient-to-br from-pink-400/40 to-rose-500/40 dark:from-pink-500/20 dark:to-rose-500/20',
  ...
  sports: {
    ...
    bgColor: 'bg-gradient-to-br from-red-400/40 to-orange-500/40 dark:from-red-500/20 dark:to-orange-500/20',
  ...
  technology: {
    ...
    bgColor: 'bg-gradient-to-br from-cyan-400/40 to-blue-500/40 dark:from-cyan-500/20 dark:to-blue-500/20',
  ...
  diplomacy: {
    ...
    bgColor: 'bg-gradient-to-br from-amber-400/40 to-yellow-500/40 dark:from-[--intel-gold]/20 dark:to-yellow-500/20',
  ...
  music: {
    ...
    bgColor: 'bg-gradient-to-br from-violet-400/40 to-purple-500/40 dark:from-violet-500/20 dark:to-purple-500/20',
  ...
  film: {
    ...
    bgColor: 'bg-gradient-to-br from-indigo-400/40 to-purple-500/40 dark:from-indigo-500/20 dark:to-purple-500/20',
  ...
  environmental: {
    ...
    bgColor: 'bg-gradient-to-br from-teal-400/40 to-green-500/40 dark:from-teal-500/20 dark:to-green-500/20',
  ...
  science: {
    ...
    bgColor: 'bg-gradient-to-br from-sky-400/40 to-blue-500/40 dark:from-sky-500/20 dark:to-blue-500/20',
  ...
  trade: {
    ...
    bgColor: 'bg-gradient-to-br from-emerald-400/40 to-teal-500/40 dark:from-emerald-500/20 dark:to-teal-500/20',
  ...
  humanitarian: {
    ...
    bgColor: 'bg-gradient-to-br from-rose-400/40 to-pink-500/40 dark:from-rose-500/20 dark:to-pink-500/20',
  ...
  agriculture: {
    ...
    bgColor: 'bg-gradient-to-br from-lime-400/40 to-green-500/40 dark:from-lime-500/20 dark:to-green-500/20',
  ...
  heritage: {
    ...
    bgColor: 'bg-gradient-to-br from-stone-400/40 to-amber-500/40 dark:from-stone-500/20 dark:to-amber-500/20',
  ...
  youth: {
    ...
    bgColor: 'bg-gradient-to-br from-fuchsia-400/40 to-pink-500/40 dark:from-fuchsia-500/20 dark:to-pink-500/20',
...
export const STATUS_STYLES = {
  planning: { color: 'text-yellow-900 dark:text-yellow-300', bg: 'bg-yellow-200/90 dark:bg-yellow-900/80', icon: '⏳', label: 'Planning' },
  active: { color: 'text-green-900 dark:text-green-300', bg: 'bg-green-200/90 dark:bg-green-900/80', icon: '🔴', label: 'Live' },
  completed: { color: 'text-blue-900 dark:text-blue-300', bg: 'bg-blue-200/90 dark:bg-blue-900/80', icon: '✓', label: 'Completed' },
  cancelled: { color: 'text-gray-900 dark:text-gray-300', bg: 'bg-gray-200/90 dark:bg-gray-900/80', icon: '✗', label: 'Cancelled' }
} as const;
