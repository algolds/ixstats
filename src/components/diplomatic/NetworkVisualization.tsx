  ...
  return (
    <div className="relative">
      ...
      <canvas
        ...
        width={width}
        height={height}
        className="rounded-lg border border-white/10 bg-black/20 cursor-move"
      ...
      <AnimatePresence>
        {hoveredNode && hoveredNode.type !== 'self' && (
          <motion.div
            ...
            className="absolute top-4 right-4 bg-black/90 backdrop-blur-xl border border-white/20 rounded-lg p-4 shadow-2xl max-w-xs"
          >
            ...
            {hoveredNode.data && (
              <div className="space-y-1 text-xs text-white/70">
                ...
                {hoveredNode.data.tradeVolume && (
                  <p>
                    Trade: <span className="text-white">${(hoveredNode.data.tradeVolume / 1000000).toFixed(1)}M</span>
                  </p>
                )}
              </div>
            )}
      ...
      <div className="absolute bottom-4 left-4 flex gap-2">
        <button
          ...
          className="px-3 py-1.5 bg-black/90 backdrop-blur-xl border border-white/20 rounded text-xs text-white hover:bg-white/10 transition-colors"
        >
          Reset View
        </button>
        <button
      ...
      {/* Legend */}
      <div className="absolute top-4 left-4 bg-black/90 backdrop-blur-xl border border-white/20 rounded-lg p-3 shadow-2xl">
