...
export const theme: Theme = {
  ...
  slots: {
    consentBannerCard: "border border-slate-200 bg-white/95 backdrop-blur-sm shadow-md",
    consentDialogCard: "border border-slate-200 bg-white/95 backdrop-blur-md shadow-xl",
    buttonPrimary: "bg-blue-600 text-white hover:bg-blue-700 shadow-sm transition-colors",
    buttonSecondary:
