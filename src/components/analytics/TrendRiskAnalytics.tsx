...
export function TrendRiskAnalytics({ countryId, userId }: TrendRiskAnalyticsProps) {
    ...
    const factors = [
      {
        ...
        risk:
          analytics.volatility?.gdp > 0.15
            ? "high"
            : analytics.volatility?.gdp > 0.1
              ? "medium"
              : "low",
      ...
      },
      {
        ...
        risk:
          securityDashboard.criticalThreats > 0
            ? "critical"
            : securityDashboard.activeThreats > 3
              ? "high"
              : securityDashboard.activeThreats > 1
                ? "medium"
                : "low",
  ...
  const trendData = React.useMemo(() => {
    ...
    return {
      gdp: {
        ...
        confidence:
          analytics.trends.gdp === "growing" ? 85 : analytics.trends.gdp === "declining" ? 75 : 90,
      },
      population: {
  ...
  const volatilityData = React.useMemo(() => {
    ...
    return [
      ...
      {
        name: "Overall",
        value: Math.round((analytics.volatility.overall || 0) * 100),
        fill: "#ffc658",
      },
    ];
  }, [analytics]);
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Advanced analysis of economic trends and risk factors
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
            ...
            <GlassCard variant="social">
              <div className="p-6 pb-4">
                ...
                <p className="text-muted-foreground mt-1 text-sm">
                  Current risk factors and overall assessment
                </p>
              </div>
              <div className="p-6">
            ...
            <GlassCard variant="social">
              <div className="p-6 pb-4">
                ...
                <p className="text-muted-foreground mt-1 text-sm">Key economic trend indicators</p>
              </div>
              <div className="p-6">
                <div className="space-y-4">
            ...
            <GlassCard variant="social">
              <div className="p-6 pb-4">
                ...
                <p className="text-muted-foreground mt-1 text-sm">Critical metrics at a glance</p>
              </div>
              <div className="p-6">
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="rounded-lg border p-4 text-center">
                    <div className="text-2xl font-bold text-green-600">
                      {analytics?.correlations?.overallHealth
                        ? Math.round(analytics.correlations.overallHealth * 100)
                        : 0}
                      %
                    </div>
                  ...
                  <div className="rounded-lg border p-4 text-center">
                    <div className="text-2xl font-bold text-orange-600">
                      {volatilityData.reduce((acc, item) => acc + item.value, 0) /
                        volatilityData.length || 0}
                      %
                    </div>
                    <div className="text-muted-foreground text-sm">Avg Volatility</div>
                  </div>
                </div>
              </div>
            </GlassCard>
          ...
          <div className="space-y-6">
            ...
            <GlassCard variant="social">
              <div className="p-6 pb-4">
                ...
                <p className="text-muted-foreground mt-1 text-sm">
                  GDP, population, and economic indicators over time
                </p>
              </div>
              <div className="p-6">
              ...
              {riskFactors.map((factor, index) => (
                <GlassCard key={index} variant="social">
                  <div className="p-6 pb-4">
                    ...
                    <p className="text-muted-foreground mt-1 text-sm">{factor.description}</p>
                  </div>
                  <div className="p-6">
                    <div className="space-y-4">
                      <div>
                      ...
                      <div className="text-muted-foreground text-sm">
                        This factor contributes to the overall risk assessment based on current
