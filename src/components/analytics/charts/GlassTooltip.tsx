...
export const GlassTooltip = React.memo<GlassTooltipProps>(
  ({ active, payload, label, formatter }) => {
    ...
    return (
      <motion.div
        ...
        className="rounded-lg border border-gray-200/50 bg-white/90 p-3 shadow-lg backdrop-blur-md dark:border-gray-700/50 dark:bg-gray-900/90"
      >
        {label && (
