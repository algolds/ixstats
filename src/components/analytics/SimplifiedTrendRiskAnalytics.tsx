  ...
  return (
    <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
      ...
      <TabsContent value="overview" className="space-y-4">
        ...
        >
          <motion.div variants={itemVariants} whileHover={cardHover}>
            <Card className="bg-gradient-to-br from-indigo-50/80 to-purple-50/80 dark:from-indigo-900/20 dark:to-purple-900/20 border-indigo-200/50 dark:border-indigo-700/30 h-full">
              <CardHeader>
                ...
                <div className="space-y-3">
                  {riskDistribution.map((item, idx) => (
                    ...
                    >
                      ...
                      <Badge variant="outline" className="font-bold">{item.value}</Badge>
                    </motion.div>
                  ))}
                </div>
              </CardContent>
          ...
          <motion.div variants={itemVariants} whileHover={cardHover}>
            <Card className="bg-gradient-to-br from-cyan-50/80 to-blue-50/80 dark:from-cyan-900/20 dark:to-blue-900/20 border-cyan-200/50 dark:border-cyan-700/30 h-full">
              <CardHeader>
                <CardTitle className="flex items-center gap-2 text-sm font-medium">
              ...
              <CardContent>
                <div className="grid grid-cols-2 gap-3">
                  <motion.div 
                    className="rounded-xl bg-gradient-to-br from-blue-100 to-blue-50 dark:from-blue-900/30 dark:to-blue-800/20 border border-blue-200/50 dark:border-blue-700/30 p-3 text-center shadow-sm"
                  ...
                  <motion.div 
                    className="rounded-xl bg-gradient-to-br from-green-100 to-emerald-50 dark:from-green-900/30 dark:to-emerald-800/20 border border-green-200/50 dark:border-green-700/30 p-3 text-center shadow-sm"
                    whileHover={{ scale: 1.02 }}
                  >
                    <div className="text-xl font-bold text-green-600 dark:text-green-400">{healthScore}%</div>
                    <div className="text-muted-foreground text-xs">Health Score</div>
                  </motion.div>
                  <motion.div 
                    className="rounded-xl bg-gradient-to-br from-purple-100 to-violet-50 dark:from-purple-900/30 dark:to-violet-800/20 border border-purple-200/50 dark:border-purple-700/30 p-3 text-center shadow-sm"
                    whileHover={{ scale: 1.02 }}
                  >
                    <div className="text-xl font-bold text-purple-600 dark:text-purple-400">{activeThreats}</div>
                    <div className="text-muted-foreground text-xs">Active Threats</div>
                  </motion.div>
                  <motion.div 
                    className="rounded-xl bg-gradient-to-br from-red-100 to-rose-50 dark:from-red-900/30 dark:to-rose-800/20 border border-red-200/50 dark:border-red-700/30 p-3 text-center shadow-sm"
                    whileHover={{ scale: 1.02 }}
                  >
      ...
      <TabsContent value="trends" className="space-y-4">
        ...
        >
          <motion.div variants={itemVariants} whileHover={cardHover}>
            <Card className="bg-gradient-to-br from-emerald-50/80 to-teal-50/80 dark:from-emerald-900/20 dark:to-teal-900/20 border-emerald-200/50 dark:border-emerald-700/30">
              <CardHeader>
              ...
              <CardContent>
                {historicalData && historicalData.length >= 2 ? (
                  <div className="space-y-4">
                    <motion.div 
                      className="p-4 rounded-xl bg-gradient-to-br from-blue-50 to-cyan-50 dark:from-blue-900/20 dark:to-cyan-900/20 border border-blue-200/50 dark:border-blue-700/30"
                      initial={{ opacity: 0, y: 10 }}
                      animate={{ opacity: 1, y: 0 }}
                      transition={{ delay: 0.1 }}
                    >
                      <div className="mb-3 flex items-center justify-between">
                        <span className="text-sm font-semibold text-blue-700 dark:text-blue-400">GDP Per Capita Trend</span>
                        <Badge
                          variant={
                    ...
                    <motion.div 
                      className="p-4 rounded-xl bg-gradient-to-br from-purple-50 to-violet-50 dark:from-purple-900/20 dark:to-violet-900/20 border border-purple-200/50 dark:border-purple-700/30"
                      initial={{ opacity: 0, y: 10 }}
                      animate={{ opacity: 1, y: 0 }}
                      transition={{ delay: 0.2 }}
                    >
                      <div className="mb-3 flex items-center justify-between">
                        <span className="text-sm font-semibold text-purple-700 dark:text-purple-400">Population Trend</span>
                        <Badge
                          variant={
        ...
        >
          {riskFactors.map((factor, idx) => (
            ...
            >
              <Card className={`${
                factor.risk === "high" 
                  ? "bg-gradient-to-br from-red-50/80 to-rose-50/80 dark:from-red-900/20 dark:to-rose-900/20 border-red-200/50 dark:border-red-700/30"
                  : factor.risk === "medium"
                    ? "bg-gradient-to-br from-amber-50/80 to-yellow-50/80 dark:from-amber-900/20 dark:to-yellow-900/20 border-amber-200/50 dark:border-amber-700/30"
      ...
      <TabsContent value="volatility" className="space-y-4">
        ...
        >
          <motion.div variants={itemVariants} whileHover={cardHover}>
            <Card className="bg-gradient-to-br from-orange-50/80 to-amber-50/80 dark:from-orange-900/20 dark:to-amber-900/20 border-orange-200/50 dark:border-orange-700/30">
              <CardHeader>
                ...
                <div className="space-y-3">
                  ...
                  >
                    <div className="mb-3 flex justify-between items-center">
                      <span className="text-sm font-semibold text-blue-700 dark:text-blue-400">GDP Volatility</span>
                      <Badge variant="outline" className="font-bold">{volatility.gdp.toFixed(2)}%</Badge>
                    </div>
                  ...
                  >
                    <div className="mb-3 flex justify-between items-center">
                      <span className="text-sm font-semibold text-purple-700 dark:text-purple-400">Population Volatility</span>
                      <Badge variant="outline" className="font-bold">{volatility.population.toFixed(2)}%</Badge>
                    </div>
                    <Progress value={Math.min(100, volatility.population * 20)} className="h-3" />
                  </motion.div>
                  <motion.div 
                    className="p-4 rounded-xl bg-gradient-to-br from-emerald-50 to-green-50 dark:from-emerald-900/20 dark:to-green-900/20 border border-emerald-200/50 dark:border-emerald-700/30"
                    initial={{ opacity: 0, y: 10 }}
                    animate={{ opacity: 1, y: 0 }}
                    transition={{ delay: 0.3 }}
                  >
                    <div className="mb-3 flex justify-between items-center">
                      <span className="text-sm font-semibold text-emerald-700 dark:text-emerald-400">Overall Stability</span>
                      <Badge variant="default" className="font-bold bg-emerald-500">{(100 - volatility.overall).toFixed(1)}%</Badge>
                    </div>
