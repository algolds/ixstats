...
interface ArrowTrendingUpIconProps extends HTMLAttributes<HTMLSpanElement> {
  size?: number;
}
...
const ArrowTrendingUpIcon = forwardRef<ArrowTrendingUpIconHandle, ArrowTrendingUpIconProps>(
