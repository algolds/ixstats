        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-4">
          {compositions.map((comp, idx) => {
            ...
            return (
              <div
                key={idx}
                className="group relative flex flex-col items-center gap-4 rounded-xl border border-white/5 bg-zinc-900/30 p-4 shadow-md transition-all duration-200 hover:border-amber-500/25 hover:bg-zinc-900/50"
              >
                {/* Shield box */}
                <div
