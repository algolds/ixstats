...
export default function PropertiesPanel() {
  ...
  if (!selectedLayerPath) {
    return (
      <div className="flex h-full items-center justify-center rounded-xl border border-white/5 bg-zinc-900/60 p-6 text-center text-xs text-zinc-500 italic">
  ...
  if (selectedLayerPath === "shield") {
    return (
      <div className="flex flex-col gap-4 rounded-xl border border-white/5 bg-zinc-900/60 p-4 text-xs">
  ...
  if (selectedLayerPath === "shield.field") {
    ...
    return (
      <div className="flex flex-col gap-4 overflow-y-auto rounded-xl border border-white/5 bg-zinc-900/60 p-4 text-xs">
        <h3 className="border-b border-white/5 pb-2 text-[10px] font-bold tracking-wider text-zinc-300 uppercase">
          Field Properties
        </h3>
  ...
  if (selectedLayerPath === "externals") {
    ...
    return (
      <div className="flex max-h-[80vh] flex-col gap-4 overflow-y-auto rounded-xl border border-white/5 bg-zinc-900/60 p-4 text-xs">
        <h3 className="border-b border-white/5 pb-2 text-[10px] font-bold tracking-wider text-zinc-300 uppercase">
