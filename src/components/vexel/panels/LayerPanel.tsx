...
export default function LayerPanel() {
  ...
  return (
    <div className="flex h-full flex-col rounded-xl border border-white/5 bg-zinc-900/60 p-4 backdrop-blur-md">
      ...
      <div className="flex-1 space-y-4 overflow-y-auto">
        ...
        <div className="space-y-1.5">
          ...
          >
            <span className="flex items-center gap-2">🛡️ Shield ({composition.shield.shape})</span>
          </div>
