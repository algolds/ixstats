  ...
  return (
    <Card className="w-full">
      <CardHeader className="pb-4">
        <div className="flex items-center justify-between">
          <CardTitle className="flex items-center text-lg font-semibold text-[var(--color-text-primary)]">
            <Building2 className="mr-2 h-5 w-5 text-[var(--color-brand-primary)]" />
      ...
      <CardContent className="space-y-4">
        {/* Budget Summary */}
        <div className="grid grid-cols-2 gap-4 rounded-lg bg-[var(--color-bg-tertiary)] p-3">
          <div>
          ...
          <div>
            ...
            <div
              className={`text-lg font-semibold ${remainingPercent < 0 ? "text-red-600" : "text-green-600"}`}
            >
              {remainingPercent.toFixed(1)}% (
              {formatCurrency((departmentBudget * remainingPercent) / 100)})
            </div>
          </div>
        </div>
                  ...
                  <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
                    ...
                    <div className="space-y-3">
                      ...
                      <Select
                        ...
                        onValueChange={(value: BudgetType) =>
                          handleUpdate(index, "budgetType", value)
                        }
                        disabled={isReadOnly}
                      >
                        <SelectTrigger>
                              ...
                              <SelectItem key={type} value={type}>
                                <div className="flex items-center">
                                  <TypeIcon
                                    ...
                                    style={{ color: budgetTypeColors[type] }}
                                  />
                                  {type}
                                </div>
                              </SelectItem>
                    ...
                    <div className="space-y-3">
                      <div className="space-y-2">
                        ...
                        <Select
                          value={item.priority}
                          onValueChange={(value: BudgetPriority) =>
                            handleUpdate(index, "priority", value)
                          }
                          disabled={isReadOnly}
                        >
                          <SelectTrigger>
                  ...
                  <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                    <div className="space-y-3">
                      ...
                      <Select
                        ...
                        onValueChange={(value: BudgetType) =>
                          setNewBudget((prev) => ({ ...prev, budgetType: value }))
                        }
                      >
                        <SelectTrigger>
                          <SelectValue />
                    ...
                    <div className="space-y-3">
                      <div className="space-y-2">
                        <Label className="text-sm">
                          Percentage: {newBudget.percent.toFixed(1)}%
                        </Label>
                        <Slider
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <Switch
                          ...
                          onCheckedChange={(checked) =>
                            setNewBudget((prev) => ({ ...prev, isRecurring: checked }))
                          }
                        />
                      </div>
                    </div>
