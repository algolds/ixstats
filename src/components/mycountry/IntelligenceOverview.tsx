...
const briefingTypeConfig = {
  ...
  risk_mitigation: { icon: Target, label: 'Risk Mitigation', color: 'text-yellow-600', bg: 'bg-yellow-50 dark:bg-yellow-950/20' },
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <Link href={createUrl("/mycountry/intelligence#focus")}>
          <Card className="glass-surface glass-refraction cursor-pointer hover:shadow-lg transition-all h-full">
            <CardHeader>
