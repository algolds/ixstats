...
function MyCountryTabSystemComponent({ variant = "unified" }: MyCountryTabSystemProps) {
  ...
  useEffect(() => {
    const handleHashChange = () => {
      ...
      const validTabs = ["overview", "economy", "labor", "government", "demographics", "analytics"];
                    ...
                    },
                    {
                      ...
                      trend:
                        smartNormalizeGrowthRate(
                          ...
                          ? "up"
                          : "stable",
                      trendValue: smartNormalizeGrowthRate(
                        country.realGDPGrowthRate || country.adjustedGdpGrowth,
                        0
                      ),
