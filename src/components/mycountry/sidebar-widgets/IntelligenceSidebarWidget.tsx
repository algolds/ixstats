...
import { Brain, Shield, AlertTriangle, Globe } from "lucide-react";
...
export function IntelligenceSidebarWidget({ countryId }: IntelligenceSidebarWidgetProps) {
  ...
  const stats = [
    { icon: Shield, label: "Security", value: `${securityScore}/100`, sub: securityLevel, color: "text-indigo-600 dark:text-indigo-400", bg: "bg-indigo-50 dark:bg-indigo-950/50" },
    ...
    { icon: Globe, label: "Network", value: `${activeEmbassies} active`, sub: "embassies", color: "text-indigo-600 dark:text-indigo-400", bg: "bg-indigo-50 dark:bg-indigo-950/50" },
  ];
