  ...
  return (
    <div className={cn("pt-1", className)}>
      <button
        ...
        className="text-muted-foreground hover:text-foreground inline-flex cursor-pointer items-center gap-1.5 rounded-xl border border-white/10 bg-white/[0.04] px-2.5 py-1 text-[10px] font-medium tracking-tight transition-all duration-150 hover:bg-white/[0.08] active:scale-[0.96]"
      >
        <ChevronDown
      ...
      {expanded && (
        <div className="animate-in fade-in mt-2 space-y-1.5 rounded-xl border border-white/10 bg-black/30 p-2.5 shadow-inner duration-150">
          {subEdits.map((sub: any, i: number) => {
            ...
            return (
              ...
              >
                ...
                <span className="text-muted-foreground/60 ml-2 shrink-0 font-medium tabular-nums">
