    ...
    .mutation(async ({ ctx, input }) => {
      ...
      try {
        ...
        await ctx.db.vitalitySnapshot.createMany({
          data: [
            { countryId: input.countryId, area: "ECONOMIC", score: vitalityScores.economicVitality, trend: "stable", changeValue: 0, changePeriod: "current", keyMetrics: "{}", peerAverage: 0, regionalAverage: 0, historicalBest: 0, rank: 0, totalCountries: 0, ixTime, calculatedAt: now },
            { countryId: input.countryId, area: "SOCIAL", score: vitalityScores.populationWellbeing, trend: "stable", changeValue: 0, changePeriod: "current", keyMetrics: "{}", peerAverage: 0, regionalAverage: 0, historicalBest: 0, rank: 0, totalCountries: 0, ixTime, calculatedAt: now },
            { countryId: input.countryId, area: "DIPLOMATIC", score: vitalityScores.diplomaticStanding, trend: "stable", changeValue: 0, changePeriod: "current", keyMetrics: "{}", peerAverage: 0, regionalAverage: 0, historicalBest: 0, rank: 0, totalCountries: 0, ixTime, calculatedAt: now },
            { countryId: input.countryId, area: "GOVERNANCE", score: vitalityScores.governmentalEfficiency, trend: "stable", changeValue: 0, changePeriod: "current", keyMetrics: "{}", peerAverage: 0, regionalAverage: 0, historicalBest: 0, rank: 0, totalCountries: 0, ixTime, calculatedAt: now },
          ],
        });
