  ...
  update: adminProcedure
    .input(
      z.object({
        ...
        constants: z.record(z.string(), z.union([z.string(), z.number(), z.boolean()])).optional(),
  ...
  testFormula: adminProcedure
    ...
    .mutation(async ({ ctx, input }) => {
      ...
      if (input.formulaId === "gdp-growth") {
        ...
        const globalGrowthFactor =
          input.testInputs.globalGrowthFactor ?? CONFIG_CONSTANTS.GLOBAL_GROWTH_FACTOR;
