...
export const TAX_GOVERNMENT_SYNERGIES: TaxGovernmentSynergy[] = [
  // Digital Government Synergies
  {
    ...
    description:
      "Digital tax filing and automated income verification dramatically improve collection",
  },
  {
  ...
  // Federal System Synergies (with challenges)
  {
    ...
    description:
      "Federal tax coordination requires inter-governmental cooperation (moderate efficiency loss)",
  },
  {
    taxComponent: "SALES",
    governmentComponent: ComponentType.FEDERAL_SYSTEM,
  ...
  },
  {
    ...
    description:
      "Corporate surveillance identifies tax avoidance but creates adversarial relationship",
  },
  {
    taxComponent: "CAPITAL_GAINS",
    governmentComponent: ComponentType.SURVEILLANCE_SYSTEM,
  ...
  // Democratic Process Synergies
  {
    ...
    description:
      "Democratic legitimacy increases voluntary tax compliance despite slower implementation",
  },
  {
    taxComponent: "PROPERTY",
    governmentComponent: ComponentType.DEMOCRATIC_PROCESS,
  ...
  // Social Democracy Synergies
  {
    ...
    effectivenessMultiplier: 1.4,
    description:
      "Social contract model creates exceptional tax compliance in exchange for services",
  },
  {
    taxComponent: "CORPORATE",
    governmentComponent: ComponentType.SOCIAL_DEMOCRACY,
...
export const TAX_ECONOMY_IMPACT: TaxEconomyImpact[] = [
  // Personal Income Tax
  {
    ...
    description:
      "Progressive income tax reduces inequality but moderately dampens consumption and growth. Encourages formalization.",
  },
  ...
  // Corporate Income Tax
  {
    ...
    description:
      "Corporate tax significantly reduces business investment and can drive informalization. Moderate inequality reduction.",
  },
  ...
  // Sales Tax / VAT
  {
    ...
    consumerSpendingModifier: -0.1,
    formalEconomyShare: 0.05,
    revenueEfficiencyModifier: 0.82,
    description:
      "VAT/sales tax is regressive (increases inequality) but highly efficient. Dampens consumption, encourages formalization.",
  },
  ...
  // Property Tax
  {
    ...
    description:
      "Property tax is progressive with minimal growth impact. Highly efficient and stable revenue source.",
  },
  ...
  // Capital Gains Tax
  {
    ...
    consumerSpendingModifier: 0.0,
    formalEconomyShare: 0.02,
    revenueEfficiencyModifier: 0.6,
    description:
      "Capital gains tax strongly reduces inequality but significantly dampens investment. Difficult to enforce.",
  },
  ...
  // Estate Tax
  {
    ...
    incomeInequalityModifier: -0.1,
    businessInvestmentModifier: -0.05,
    consumerSpendingModifier: 0.0,
    formalEconomyShare: 0.0,
    revenueEfficiencyModifier: 0.55,
    description:
      "Estate tax maximally reduces wealth inequality with minimal growth impact. Very difficult to collect efficiently.",
  },

  // Gift Tax
  {
    taxComponent: "GIFT",
    gdpGrowthModifier: 0.0,
    incomeInequalityModifier: -0.03,
    businessInvestmentModifier: 0.0,
    consumerSpendingModifier: 0.0,
    formalEconomyShare: 0.0,
    revenueEfficiencyModifier: 0.45,
    description:
      "Gift tax prevents estate tax evasion, modest inequality reduction. Extremely difficult to enforce.",
  },

  // Customs Duties / Tariffs
  {
    taxComponent: "CUSTOMS",
    gdpGrowthModifier: -0.03,
    incomeInequalityModifier: 0.02,
    businessInvestmentModifier: -0.08,
    consumerSpendingModifier: -0.06,
    formalEconomyShare: -0.01,
    revenueEfficiencyModifier: 0.9,
    description:
      "Tariffs reduce growth through inefficiency, slightly regressive. Easy to collect but economically distortionary.",
  },
  ...
  // Excise Tax (Sin Taxes)
  {
    ...
    description:
      "Excise taxes on tobacco, alcohol, fuel generate revenue while addressing externalities. Slightly regressive.",
  },

  // Payroll Tax
  {
    taxComponent: "PAYROLL",
    gdpGrowthModifier: -0.01,
    incomeInequalityModifier: -0.02,
    ...
    description:
      "Payroll taxes efficient but discourage formal employment. Moderate growth and inequality impact.",
  },
  ...
  // Other Taxes (aggregated minor taxes)
  {
    taxComponent: "OTHER",
    gdpGrowthModifier: -0.005,
    incomeInequalityModifier: 0.0,
    businessInvestmentModifier: -0.02,
    consumerSpendingModifier: -0.01,
    formalEconomyShare: 0.0,
    revenueEfficiencyModifier: 0.7,
    description:
      "Miscellaneous taxes have varying impacts depending on design. Generally moderate efficiency.",
  },
];
...
export const TAX_CROSS_BUILDER_SYNERGIES: CrossBuilderSynergy[] = [
  // Advanced Economy × Digital Government × Progressive Income Tax
  {
    ...
    compoundEffectiveness: 1.6,
    thresholdRequirement: "GDP per capita > $40,000",
    description:
      "Advanced digital infrastructure enables sophisticated progressive taxation with minimal evasion",
  },
  ...
  // High Inequality × Progressive Income × Institutional Legitimacy
  {
    ...
    compoundEffectiveness: 1.5,
    thresholdRequirement: "Gini coefficient > 0.40",
    description:
      "Strong institutions enable progressive taxation to address inequality without capital flight",
  },
  ...
  // Export-Led Economy × Developmental State × Customs
  {
    ...
    compoundEffectiveness: 1.4,
    thresholdRequirement: "Exports > 40% of GDP",
    description:
      "Strategic tariff policy supports industrial development in export-oriented economy",
  },
  ...
  // Financial Center × Meritocratic × Capital Gains
  {
    ...
    description:
      "Expert administration essential for complex capital gains taxation in financial centers",
  },
  ...
  // High Formalization × Professional Bureaucracy × Corporate Tax
  {
    ...
    description:
      "Professional tax administration maximizes corporate tax collection in formalized economy",
  },
  ...
  // Innovation Economy × Performance Legitimacy × Corporate Tax
  {
    ...
    description:
      "Performance-based legitimacy enables corporate taxation when government delivers results for innovation",
  },
...
export function getUnifiedTaxEffectiveness(
  ...
  categories.forEach((category) => {
    ...
    governmentComponents.forEach((govComp) => {
      ...
      const crossSynergy = TAX_CROSS_BUILDER_SYNERGIES.find(
        (s) =>
          s.taxComponent === category.categoryType &&
  ...
  const overallScore = Math.max(
    0,
    Math.min(100, baseScore + synergyBonus + crossBuilderBonus - economicPenalty)
  );
...
export function calculateTaxCollectionEfficiency(
  ...
  const finalEfficiency = Math.min(
    95,
    baseEfficiency * collectionMultiplier * (1 + formalizationBonus + developmentBonus)
  );

  // Calculate metrics
  const categories = taxSystem.taxCategories || [];
  const theoreticalRevenue = categories.reduce(
    (sum, cat) => sum + (cat.baseRate || 0) * 1000000,
    0
  );
 ...
 */
export function getTaxEconomyImpact(taxCategories: TaxCategory[]): TaxEconomyImpact[] {
...
export function detectTaxSystemIssues(
  ...
  if (
    economicData.gdpPerCapita > 40000 &&
    ...
    issues.push({
      ...
      description:
        "Advanced economy lacks digital tax infrastructure, losing 25-35% collection efficiency",
      impact: 25,
      recommendation:
        "Implement Digital Government component for automated tax collection and filing",
  ...
  if (economicData.giniCoefficient > 0.45) {
    const hasProgressiveIncome = categories.some(
      (c) => c.categoryType === "INCOME" && (c.rate || 0) > 30
    );
    ...
    if (!hasProgressiveIncome) {
      issues.push({
        ...
        description:
          "Gini coefficient above 0.45 without strong progressive income tax to address inequality",
        impact: 20,
        recommendation:
          "Implement progressive income tax or capital gains tax to reduce inequality",
  ...
  if (
    governmentComponents.includes(ComponentType.SURVEILLANCE_SYSTEM) &&
  ...
  if (governmentComponents.includes(ComponentType.FEDERAL_SYSTEM)) {
    ...
    if (complexTaxes.length > 2) {
      issues.push({
        ...
        description:
          "Multiple complex taxes in federal system create coordination inefficiencies (-12% efficiency)",
        impact: 12,
  ...
  if (economicData.formalEconomyShare < 0.6) {
    const complexTaxes = categories.filter((c) =>
  ...
  if (
    ...
    issues.push({
      ...
      description:
        "Complex multi-tax system requires professional tax administration (-20% efficiency)",
      impact: 20,
      recommendation:
        "Implement Professional Bureaucracy or Meritocratic System for tax administration",
  ...
  if (vatRate > incomeRate * 1.5 && economicData.giniCoefficient > 0.35) {
    issues.push({
      ...
      description:
        "Heavy reliance on VAT/sales tax increases inequality in already unequal society",
      impact: 15,
