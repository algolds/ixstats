...
export const DEPLOY_LOG: LogEntry[] = [
  {
    level: "info",
    message: "Build triggered by push to main (abc1234)",
    timestamp: "2026-03-11T14:00:00.000Z",
  },
  { level: "debug", message: "Cloning repository…", timestamp: "2026-03-11T14:00:00.500Z" },
  {
    level: "debug",
    message: "Installing dependencies (pnpm install)…",
    timestamp: "2026-03-11T14:00:02.100Z",
  },
  {
    level: "info",
    message: "Dependencies installed in 8.3s",
    timestamp: "2026-03-11T14:00:10.400Z",
  },
  { level: "debug", message: "Running linter…", timestamp: "2026-03-11T14:00:10.500Z" },
  {
    level: "info",
    message: "Lint passed (0 warnings, 0 errors)",
    timestamp: "2026-03-11T14:00:14.200Z",
  },
  ...
  {
    level: "info",
    message: "Type check completed with 1 warning",
    timestamp: "2026-03-11T14:00:18.200Z",
  },
  {
    level: "debug",
    message: "Building application (next build)…",
    timestamp: "2026-03-11T14:00:18.300Z",
  },
  {
    level: "info",
    message: "Compiled 142 modules in 12.4s",
    timestamp: "2026-03-11T14:00:30.700Z",
  },
  { level: "info", message: "Generated 23 static pages", timestamp: "2026-03-11T14:00:31.200Z" },
  {
    level: "info",
    message: "Bundle size: 245 KB (gzipped)",
    timestamp: "2026-03-11T14:00:31.500Z",
  },
  ...
  {
    level: "debug",
    message: "Provisioning edge functions…",
    timestamp: "2026-03-11T14:00:35.200Z",
  },
  {
    level: "info",
    message: "3 edge functions deployed to 12 regions",
    timestamp: "2026-03-11T14:00:38.800Z",
  },
  { level: "debug", message: "Running health checks…", timestamp: "2026-03-11T14:00:39.000Z" },
  {
    level: "info",
    message: "Health check passed (all regions responding)",
    timestamp: "2026-03-11T14:00:41.500Z",
  },
