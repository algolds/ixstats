...
export const SECTION_THEME_CLASSES = {
  overview: {
    ...
    darkBorder: "dark:border-amber-500/10",
    text: "text-amber-500",
    ring: "#f59e0b",
  },
  executive: {
  ...
  intelligence: {
    ...
    darkBorder: "dark:border-blue-500/10",
    text: "text-blue-500",
    ring: "#3b82f6",
  },
  defense: {
    ...
    darkBorder: "dark:border-red-500/10",
    text: "text-red-500",
    ring: "#ef4444",
  },
  politics: {
    gradient: "from-indigo-900 to-zinc-950",
    activeGlow: "shadow-indigo-500/10",
    border: "border-indigo-500/20",
    darkBorder: "dark:border-indigo-500/10",
