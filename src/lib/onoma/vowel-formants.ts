...
export const IPA_VOWEL_FORMANTS: Record<string, VowelFormant> = {
  ...
  y: { ipa: "y", f1: 290, f2: 2000, label: "Close Front Rounded", category: "front", openness: "close" },
  ɪ: { ipa: "ɪ", f1: 390, f2: 1990, label: "Near-Close Front", category: "front", openness: "near-close" },
  e: { ipa: "e", f1: 400, f2: 1900, label: "Close-Mid Front", category: "front", openness: "close-mid" },
  ø: { ipa: "ø", f1: 410, f2: 1600, label: "Close-Mid Front Rounded", category: "front", openness: "close-mid" },
  ɛ: { ipa: "ɛ", f1: 550, f2: 1750, label: "Open-Mid Front", category: "front", openness: "open-mid" },
  œ: { ipa: "œ", f1: 560, f2: 1500, label: "Open-Mid Front Rounded", category: "front", openness: "open-mid" },
  ...
  ɒ: { ipa: "ɒ", f1: 680, f2: 1000, label: "Open Back Rounded", category: "back", openness: "open" },
  ʌ: { ipa: "ʌ", f1: 600, f2: 1170, label: "Open-Mid Back", category: "back", openness: "open-mid" },
  ɔ: { ipa: "ɔ", f1: 570, f2: 900, label: "Open-Mid Back Rounded", category: "back", openness: "open-mid" },
  o: { ipa: "o", f1: 450, f2: 950, label: "Close-Mid Back", category: "back", openness: "close-mid" },
  ʊ: { ipa: "ʊ", f1: 440, f2: 1020, label: "Near-Close Back", category: "back", openness: "near-close" },
  u: { ipa: "u", f1: 300, f2: 800, label: "Close Back", category: "back", openness: "close" },
  ə: { ipa: "ə", f1: 500, f2: 1400, label: "Mid Central (Schwa)", category: "central", openness: "close-mid" },
  ɨ: { ipa: "ɨ", f1: 300, f2: 1500, label: "Close Central", category: "central", openness: "close" },
  ʉ: { ipa: "ʉ", f1: 310, f2: 1400, label: "Close Central Rounded", category: "central", openness: "close" },
};
...
export function calculateAcousticCenter(vowels: VowelFormant[]): { f1: number; f2: number } | null {
  ...
  const total = vowels.reduce(
    (acc, v) => ({ f1: acc.f1 + v.f1, f2: acc.f2 + v.f2 }),
    { f1: 0, f2: 0 }
  );
  return {
