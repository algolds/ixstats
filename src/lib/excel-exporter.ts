...
export function exportCountriesToExcel(countries: CountryStats[]): ArrayBuffer {
  ...
  const exportData = countries.map(country => ({
    ...
    'Population Density (per km²)': country.populationDensity ? parseFloat(country.populationDensity.toFixed(2)) : '',
  ...
  const metadataSheet = XLSX.utils.json_to_sheet([
    ...
    { 'Property': 'Core Fields Tracked', 'Value': '13 (Country, Continent, Region, Government Type, Religion, Leader, Population, GDP PC, Area (km²), Area (sq mi), Max GDPPC Grow Rt, Adj GDPPC Growth, Pop Growth Rate)' },
    { 'Property': 'Note', 'Value': 'CSV import support has been removed. Only Excel (.xlsx, .xls) files are supported.' }
  ]);
  ...
  const fieldReferenceSheet = XLSX.utils.json_to_sheet([
    { 'Field Name': 'Country', 'Description': 'Country name (required)', 'Type': 'Text', 'Source': 'Excel Column A' },
    { 'Field Name': 'Continent', 'Description': 'Continental location', 'Type': 'Text', 'Source': 'Excel Column B' },
    { 'Field Name': 'Region', 'Description': 'Regional subdivision', 'Type': 'Text', 'Source': 'Excel Column C' },
    { 'Field Name': 'Government Type', 'Description': 'Form of government', 'Type': 'Text', 'Source': 'Excel Column D' },
    { 'Field Name': 'Religion', 'Description': 'Primary religion', 'Type': 'Text', 'Source': 'Excel Column E' },
    { 'Field Name': 'Leader', 'Description': 'Current leader', 'Type': 'Text', 'Source': 'Excel Column F' },
    { 'Field Name': 'Population', 'Description': 'Total population (required)', 'Type': 'Number', 'Source': 'Excel Column G' },
    { 'Field Name': 'GDP PC', 'Description': 'GDP per capita in USD (required)', 'Type': 'Number', 'Source': 'Excel Column H' },
    { 'Field Name': 'Area (km²)', 'Description': 'Land area in square kilometers', 'Type': 'Number', 'Source': 'Excel Column I' },
    { 'Field Name': 'Area (sq mi)', 'Description': 'Land area in square miles', 'Type': 'Number', 'Source': 'Excel Column J' },
    { 'Field Name': 'Max GDPPC Grow Rt', 'Description': 'Maximum GDP per capita growth rate (decimal)', 'Type': 'Percentage', 'Source': 'Excel Column K' },
    { 'Field Name': 'Adj GDPPC Growth', 'Description': 'Adjusted GDP per capita growth rate (decimal)', 'Type': 'Percentage', 'Source': 'Excel Column L' },
    { 'Field Name': 'Pop Growth Rate', 'Description': 'Population growth rate (decimal)', 'Type': 'Percentage', 'Source': 'Excel Column M' }
  ]);
