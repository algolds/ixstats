...
import {
  Settings, Building2, Users, Shield, Crown, Vote, Clock, TrendingUp, Star, Cross,
  Briefcase, Scale, Flag, Cpu, Eye, DollarSign, Target, BarChart3, Heart, Leaf,
  Brain, Monitor, Globe, Network, Award, CheckCircle, AlertTriangle, GraduationCap,
  BookOpen, Handshake, Microscope, Lightbulb, ArrowRightLeft, Copyright, Zap, Wifi,
 ...
 */
export const GOVERNMENT_TEMPLATES: Record<string, {
  name: string;
  description: string;
