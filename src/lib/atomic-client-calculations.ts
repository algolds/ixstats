...
export function calculateUnifiedEffectiveness(
  ...
  const economicScore = economicComponents.length > 0 
  ...
  const totalComponents = governmentComponents.length + economicComponents.length + taxComponents.length;
