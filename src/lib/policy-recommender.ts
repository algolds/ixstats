 ...
 */
const POLICY_TEMPLATES: Record<string, Omit<PolicyRecommendation, 'suitabilityScore' | 'meetsRequirements' | 'missingRequirements' | 'recommendationReason'> & {
  conditions: (ctx: CountryContext) => { suitable: boolean; reason: string; score: number; missing: string[] };
}> = {
  ...
  INNOVATION_HUB: {
    ...
    description: 'Establish technology and innovation centers to drive R&D, attract high-skill workers, and boost productivity.',
    policyType: 'economic',
    category: 'technology',
    priority: 'high',
    estimatedEffects: {
  ...
  FINANCIAL_SERVICES_EXPANSION: {
    ...
    description: 'Develop advanced financial services sector with modern regulatory framework to become a regional financial hub.',
    policyType: 'economic',
  ...
  EXPORT_PROMOTION: {
    ...
    description: 'Provide incentives and support for export-oriented industries to boost international trade.',
    policyType: 'economic',
    category: 'trade',
    priority: 'high',
    estimatedEffects: {
  ...
  INFRASTRUCTURE_MODERNIZATION: {
    ...
    description: 'Major investment in transportation, utilities, and digital infrastructure to support economic growth.',
  ...
  AGRICULTURAL_SUPPORT: {
    ...
    description: 'Provide support for agricultural sector through subsidies, technology, and market access improvements.',
    policyType: 'economic',
    ...
    conditions: (ctx) => {
      ...
      const isDeveloping = tier === 'Developing' || tier === 'Least Developed' || tier === 'Emerging';
  ...
  LABOR_RIGHTS_ENHANCEMENT: {
    ...
    description: 'Strengthen worker protections, improve working conditions, and ensure fair wages.',
    policyType: 'social',
  ...
  TAX_REFORM_PROGRESSIVE: {
    ...
    description: 'Implement or enhance progressive taxation to increase revenue and reduce inequality.',
    policyType: 'economic',
    category: 'taxation',
    priority: 'high',
    estimatedEffects: {
  ...
  ANTI_CORRUPTION_REFORM: {
    ...
    description: 'Strengthen institutions, increase transparency, and combat corruption to improve governance.',
