...
export const splashGold = {
  ...
  panel:
    `rounded-2xl border ${ov.border} ${ov.darkBorder} bg-amber-500/[0.03] shadow-sm dark:bg-amber-950/20`,
  subtlePanel: "rounded-xl border border-amber-500/20 bg-amber-500/[0.04] dark:border-amber-500/15 dark:bg-amber-950/25",
  ...
  iconWrapSm:
    `flex shrink-0 items-center justify-center rounded-lg border ${ov.border} bg-gradient-to-br ${ov.gradient} [&>svg]:text-white`,
  headline:
    `bg-gradient-to-r ${ov.gradient} bg-clip-text font-bold tracking-tight text-transparent`,
