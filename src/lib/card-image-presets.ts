...
export const cardImagePresets: Record<CardImageType, CardImagePreset> = {
  national_identity: {
    ...
    unsplashKeywords: ["parliament building", "government architecture", "capitol building", "national landmark"],
  ...
  head_of_government: {
    ...
    unsplashKeywords: ["cabinet room", "prime minister office", "government meeting", "official office"],
  ...
  economic_indicators: {
    ...
    unsplashKeywords: ["financial district", "stock exchange", "modern city skyline", "business district"],
  ...
  government: {
    ...
    unsplashKeywords: ["government building", "legislative chamber", "courthouse", "civic building"],
  ...
  analytics: {
    ...
    unsplashKeywords: ["data visualization", "analytics dashboard", "statistics", "business intelligence"],
  ...
  diplomacy: {
    ...
    unsplashKeywords: ["embassy", "diplomatic meeting", "international conference", "united nations"],
