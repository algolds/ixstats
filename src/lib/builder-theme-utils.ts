 ...
 */
export function getChartColor(category: string, type: keyof typeof chartColorPalette = 'primary'): string {
  if (type === 'primary') {
 ...
 */
export function getButtonColors(variant: 'primary' | 'secondary' | 'success' | 'warning' | 'error' = 'primary') {
  const variants = {
    primary: {
      base: 'bg-[var(--color-brand-primary)]/20 border-[var(--color-brand-primary)]/50 text-[var(--color-brand-primary)]',
      hover: 'hover:bg-[var(--color-brand-primary)]/30 hover:border-[var(--color-brand-primary)]/70',
      active: 'active:bg-[var(--color-brand-primary)]/40',
      selected: 'bg-[var(--color-brand-primary)]/30 border-[var(--color-brand-primary)]/70 shadow-lg'
    },
    secondary: {
      base: 'bg-[var(--color-brand-secondary)]/20 border-[var(--color-brand-secondary)]/50 text-[var(--color-brand-secondary)]',
      hover: 'hover:bg-[var(--color-brand-secondary)]/30 hover:border-[var(--color-brand-secondary)]/70',
      active: 'active:bg-[var(--color-brand-secondary)]/40',
      selected: 'bg-[var(--color-brand-secondary)]/30 border-[var(--color-brand-secondary)]/70 shadow-lg'
    },
    success: {
 ...
 */
export function generateChartColors(count: number, type: keyof typeof chartColorPalette = 'primary'): string[] {
  const colors: string[] = [];
 ...
 */
export function convertThemeColorForChart(colorVar: string, opacity: number = 1): {
  hsl: string;
  rgb: string;
  hex: string;
} {
