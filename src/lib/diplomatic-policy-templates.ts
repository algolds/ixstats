...
export const DIPLOMATIC_POLICY_TEMPLATES: DiplomaticPolicyTemplate[] = [
  // Trade Agreement Framework
  {
    ...
    description: 'Establish a comprehensive trade agreement with a partner nation, reducing tariffs and streamlining customs procedures to boost bilateral trade volume.',
    category: 'trade',
    difficulty: 'complex',
  ...
  // Cultural Exchange Policy
  {
    ...
    description: 'Launch a comprehensive cultural exchange program prioritizing arts, education, and people-to-people connections to strengthen diplomatic goodwill.',
    category: 'cultural',
    difficulty: 'moderate',
  ...
  // Embassy Expansion Strategy
  {
    ...
    description: 'Systematically expand embassy network to target regions, establishing diplomatic presence in key strategic, economic, and cultural partner nations.',
    category: 'embassy',
    difficulty: 'complex',
  ...
  // Relationship Improvement Plan
  {
    ...
    description: 'Comprehensive plan to improve strained or weak diplomatic relationships through targeted missions, exchanges, trade, and high-level engagement.',
  ...
  // Trade Diversification Policy
  {
    ...
    description: 'Reduce economic dependence on single trade partners by diversifying trade relationships across multiple regions and countries.',
    category: 'trade',
    difficulty: 'moderate',
  ...
  // Crisis Diplomatic Response
  {
    ...
    description: 'Establish protocols and capabilities for swift diplomatic response to international crises, conflicts, or humanitarian emergencies.',
    category: 'relationship',
    difficulty: 'complex',
    estimatedDuration: '3-6 months',
 ...
 */
export function getPolicyTemplatesByCategory(category: DiplomaticPolicyTemplate['category']): DiplomaticPolicyTemplate[] {
 ...
 */
export function getPolicyTemplatesByDifficulty(difficulty: DiplomaticPolicyTemplate['difficulty']): DiplomaticPolicyTemplate[] {
