...
// ═══════════════════════════════════════════════════════════════════════════
// SINGLE SOURCE OF TRUTH — All economy types are derived from these schemas.
// ❌ No manual interfaces allowed for domain models.
// ✅ Use z.infer<typeof XyzSchema> everywhere.
// ═══════════════════════════════════════════════════════════════════════════
...
export const LaborEmploymentSchema = z.object({
  ...
  // FIXED ADDITIONS (your TS errors)
...
// ===============================
// TYPES (inferred - NO MANUAL TYPES ANYMORE)
// ===============================
...
// Extended types (for UI / mapper — these are the ones consumers import)
...
// ===============================
// SAFE PARSER (THIS FIXES YOUR RUNTIME CRASHES)
// ===============================
