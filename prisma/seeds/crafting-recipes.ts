...
const craftingRecipes = [
  // FUSION RECIPES
  {
    ...
    resultType: "NATION",
    materialsRequired: [{ rarity: "COMMON", quantity: 2 }],
    ixCreditsCost: 250,
    successRate: 95,
    collectorXP: 25,
    unlockRequirement: {},
  ...
  },
  {
    ...
    resultRarity: "RARE",
    resultType: "NATION",
    materialsRequired: [{ rarity: "UNCOMMON", quantity: 2 }],
    ixCreditsCost: 500,
    successRate: 85,
    collectorXP: 50,
  ...
  },
  {
    ...
    resultType: "NATION",
    materialsRequired: [{ rarity: "RARE", quantity: 3 }],
    ixCreditsCost: 1000,
    successRate: 70,
    collectorXP: 100,
  ...
  },
  {
    ...
    resultRarity: "MYTHIC",
    resultType: "NATION",
    materialsRequired: [{ rarity: "LEGENDARY", quantity: 3 }],
    ixCreditsCost: 10000,
    successRate: 15,
    collectorXP: 1000,
  ...
  // EVOLUTION RECIPES
  {
    ...
    resultRarity: "UNCOMMON",
    resultType: "NATION",
    materialsRequired: [{ rarity: "COMMON", quantity: 1 }],
    ixCreditsCost: 200,
    successRate: 100,
    collectorXP: 20,
    unlockRequirement: {},
  ...
  },
  {
    ...
    resultRarity: "RARE",
    resultType: "NATION",
    materialsRequired: [{ rarity: "UNCOMMON", quantity: 1 }],
    ixCreditsCost: 400,
    successRate: 95,
    collectorXP: 40,
    unlockRequirement: { minLevel: 2 },
  ...
  },
  {
    ...
    resultRarity: "ULTRA_RARE",
    resultType: "NATION",
    materialsRequired: [{ rarity: "RARE", quantity: 1 }],
    ixCreditsCost: 800,
    successRate: 85,
    collectorXP: 80,
    unlockRequirement: { minLevel: 5 },
  ...
  },
  {
    ...
    resultRarity: "EPIC",
    resultType: "NATION",
    materialsRequired: [{ rarity: "ULTRA_RARE", quantity: 1 }],
    ixCreditsCost: 2000,
    successRate: 70,
    collectorXP: 200,
  ...
  },
  {
    ...
    resultRarity: "LEGENDARY",
    resultType: "NATION",
    materialsRequired: [{ rarity: "EPIC", quantity: 1 }],
    ixCreditsCost: 4000,
    successRate: 50,
    collectorXP: 400,
  ...
  // SPECIAL RECIPES
  {
    ...
    resultRarity: "RARE",
    resultType: "LORE",
    materialsRequired: [{ type: "NATION", rarity: "UNCOMMON", quantity: 3 }],
    ixCreditsCost: 750,
    successRate: 80,
    collectorXP: 75,
  ...
  },
  {
    ...
    resultRarity: "EPIC",
    resultType: "EVENT",
    materialsRequired: [{ rarity: "RARE", quantity: 2 }],
    ixCreditsCost: 1500,
    successRate: 60,
    collectorXP: 150,
