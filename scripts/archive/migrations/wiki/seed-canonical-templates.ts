...
const CANONICAL_TEMPLATES: CanonicalTemplateDef[] = [
  ...
  },
  {
    ...
    category: "infobox",
    description:
      "Head of state, diplomat, military commander, scientist, or notable historical figure.",
    params: {
      name: { label: "Full Name", required: true, example: "Arthur Vance", type: "string" },
      image: {
        label: "Portrait Image",
        example: "File:Arthur_Vance_Portrait.jpg",
        type: "wiki-file-name",
      },
      office: {
        label: "Primary Office / Title",
  ...
  },
  {
    ...
    params: {
      ...
      result: {
        ...
        required: true,
        example: "Decisive Burgundian Victory; Treaty of Vilena",
        type: "string",
      },
      combatant1: {
  ...
  },
  {
    ...
    params: {
      unit_name: {
        ...
        required: true,
        example: "1st Royal Armored Division",
        type: "string",
      },
      ...
      insignia: {
        label: "Unit Insignia",
        example: "File:1st_Armored_Patch.svg",
        type: "wiki-file-name",
      },
    },
    aliases: [
  ...
  },
  {
    ...
    params: {
      ...
      ideology: {
        ...
        required: true,
        example: "Liberal Democracy, Free Market",
        type: "string",
      },
      seats_parliament: {
        label: "Parliamentary Seats",
        example: "142 / 300 Seats (Majority)",
        type: "string",
      },
  ...
  },
  {
    ...
    category: "formatting",
    description:
      "Article disambiguation notice, main article reference, or redirect context banner.",
    params: {
      text: {
        label: "Notice Text",
        required: true,
        example: "This article is about the sovereign state. For the capital, see [[Vilena]].",
        type: "string",
      },
      type: {
        label: "Hatnote Type",
        default: "disambiguation",
        example: "disambiguation | redirect | main | see_also",
        type: "string",
      },
    },
  ...
  },
  {
    ...
    category: "formatting",
    description:
      "Highlighted speech excerpt, lore document citation, or notable quotation capsule.",
    params: {
      quote: {
        label: "Quote Text",
        required: true,
  ...
  },
  {
    ...
    params: {
      title: {
        label: "Source Article / Book Title",
        required: true,
