...
const publishableKey = envVars.NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY || process.env.NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY;
...
const isCorrectKeyType = 
  (environment === 'development' && publishableKey?.startsWith('pk_test_') && secretKey?.startsWith('sk_test_')) ||
  (environment === 'production' && publishableKey?.startsWith('pk_live_') && secretKey?.startsWith('sk_live_'));
