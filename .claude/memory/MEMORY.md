...
- [Map instances = standalone per component](project_map_standalone_architecture.md) — REVERTED the shared-singleton + snapshot approach; every map (main/editor/embed) owns its own MapLibre instance. Don't reintroduce SharedMapContext (2026-07-01, v2)
